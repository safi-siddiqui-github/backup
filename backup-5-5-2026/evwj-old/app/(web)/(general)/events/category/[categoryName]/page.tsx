...
import EventsCategoryHeroSectionComponent from "@/components/general/events/EventsCategoryHeroSectionComponent";
...
export default async function Page(props: ServerPropType) {
	const params = (await props.params) as { categoryName?: string };
	...
	// Fetch events for the selected category (client-side mock source)
			...
			<div className="relative flex flex-1 flex-col">
				...
				<div className="relative z-10">
					...
					<div className="flex flex-col p-4 xl:p-8">
						<EventsDiscoverSectionComponent 
