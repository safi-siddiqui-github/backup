import TriviaSuggestionsComponent from "@/components/general/games/trivia/TriviaSuggestionsComponent";
	...
	return (
		<div className="pt-28 md:pt-32 pb-4 px-4 md:px-8">
			<div className="max-w-7xl mx-auto">
				<TriviaSuggestionsComponent slug={slug} gameSlug={gameSlug} />
			</div>
		</div>
	);
}
