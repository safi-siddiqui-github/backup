...
export const Step6_Payment = ({
	...
	const handleApplePay = () => {
		...
		// stubbed flow — in production integrate Apple Pay JS or Payment Request API
		onNext();
	};

	const handleGooglePay = () => {
		toast.success("Google Pay selected — opening payment sheet (stub)");
		// stubbed flow — in production integrate Google Pay SDK or Payment Request API
		onNext();
	};
