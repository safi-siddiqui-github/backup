...
import { ANIMATION_PRESETS, useDevicePerfFlags, useScrollAnimation } from "../../_private/web-home-hooks";
 
import Image from "next/image";
import { getFeaturedEvents } from "../../_private/web-home-healper";
...
function HomeStatSection({ stats }: {
  stats: {
    ...
    return (
      <div className="relative pt-10 mt-10 w-full bg-black text-4xl font-bold text-white">
        <div className="relative w-full pt-10 pb-8 md:pt-10 md:pb-12">
          <p className="mb-12 text-center text-sm text-white/90 md:mb-16 md:text-base">
            Join millions of event organizers who manage their events on our platform.
          </p>
        <div className="mx-auto grid max-w-5xl grid-cols-1 gap-12 pb-12 md:grid-cols-3 md:gap-8 md:pb-16">
          <div className="flex flex-col items-center text-center">
            <h3 className="mb-3 text-5xl font-bold text-white md:text-6xl lg:text-7xl">
              {stats.organizers}M+
            </h3>
            <p className="text-sm text-white/70 md:text-base">Event Organizers Served</p>
          </div>
          <div className="flex flex-col items-center text-center">
            <h3 className="mb-3 text-5xl font-bold text-white md:text-6xl lg:text-7xl">
              ${stats.sales}B+
            </h3>
            <p className="text-sm text-white/70 md:text-base">Generated in Ticket Sales</p>
          </div>
          <div className="flex flex-col items-center text-center">
            <h3 className="mb-3 text-5xl font-bold text-white md:text-6xl lg:text-7xl">
              {stats.countries}+
            </h3>
            <p className="text-sm text-white/70 md:text-base">Countries & Territories</p>
          </div>
        </div>
      </div>
    </div>
