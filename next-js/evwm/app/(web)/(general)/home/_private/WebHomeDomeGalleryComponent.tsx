...
export default function WebHomeDomeGalleryComponent() {
  return (
    <div className="flex flex-col bg-black pt-10 text-white">
      <div className="flex flex-col p-4">
        <p className="rounded-md text-center text-4xl leading-tight md:mb-12 md:text-5xl lg:text-6xl xl:text-7xl">
          Our Event Gallery
        </p>
      </div>
      <div className="flex h-96 flex-col md:h-[400px] lg:hidden">
        <DomeGallery
          fit={0.7}
          minRadius={400}
          segments={24}
      ...
      <div className="3xl:h-[800px] 4xl:h-[900px] hidden flex-col lg:flex lg:h-[500px] xl:h-[600px]">
