...
export default function NikeImageSwapSectionOneComponent({ images, title }: { images: string[]; title: string; }) {
  ...
  return (
    <div className="grid grid-cols-2 gap-2 w-80 lg:w-full rtd">
      <Image
        id="first"
      ...
      <Image
        ...
        width={319}
        height={319}
        className="object-cover col-span-2 w-full h-96 lg:w-full rounded rtd"
        sizes="(max-width: 640px) 100vw, (max-width: 1024px) 50vw, 33vw"
      />
    </div>
  );
