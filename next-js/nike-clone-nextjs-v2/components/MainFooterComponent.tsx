...
import MainFooterDropDownComponent from "./MainFooterDropDownComponent";
  ...
  return (
    <footer className="flex flex-wrap lg:justify-center p-6 gap-6 xl:gap-10">
      ...
      <div className="flex flex-wrap gap-6">
        {footerNavData.map((eachNav) => (<MainFooterDropDownComponent key={eachNav.id} navData={eachNav} />))}
      </div>
