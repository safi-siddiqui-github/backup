import ImageSwapTwoComponent from "./ImageSwapTwoComponent";

export type CardFourProps = {
  id: string;
  title: string;
  highlight: string;
  category: string;
...
export default function CardFourComponent(props: {
  cardFourData: CardFourProps;
}) {
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <ImageSwapTwoComponent key={`card-four-${id}-${title}-${category}`} images={images} title={title} />
