	...
	return (
		<div className="relative inline-block">
			<div
				onClick={onClick}
				className={cn(
					"flex items-center justify-center rounded-full bg-linear-to-br font-semibold text-white shadow-md transition-all duration-150",
					sizeClasses[size],
					gradientClass,
			...
			{showStatus && (
				<Badge
					...
					className={cn(
						"border-background absolute -right-0.5 -bottom-0.5 flex items-center justify-center rounded-full border-2 p-0.5",
