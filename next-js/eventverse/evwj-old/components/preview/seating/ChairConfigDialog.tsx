	...
	return (
		<Dialog open={true} onOpenChange={onClose}>
			<DialogContent className="max-w-md">
				<DialogHeader>
					<DialogTitle>
						{isCreating ? "Create Chairs" : "Configure Chair"}
					</DialogTitle>
				</DialogHeader>
				...
				<div className="space-y-4">
					...
					{isCreating && (
						<div>
							...
							<RadioGroup
								...
								onValueChange={(value: "single" | "grid") =>
									setConfig({ ...config, layoutType: value })
								}
								className="mt-2"
							>
					...
					<div>
						...
						<Slider
							...
							onValueChange={([value]) =>
								setConfig({ ...config, rotation: value })
							}
							max={360}
							step={15}
							className="mt-2"
				...
				<DialogFooter>
					...
					<Button onClick={handleSave}>
						{isCreating ? "Create Chairs" : "Save Changes"}
					</Button>
				</DialogFooter>
			</DialogContent>
		</Dialog>
