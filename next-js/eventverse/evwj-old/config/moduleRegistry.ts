...
export const moduleRegistry: ModuleDefinition[] = [
	...
	},
	{
		...
		name: "Event Websites",
		description:
			"Create custom websites for your events with templates and drag-and-drop editing",
		icon: Globe,
		category: "Content",
		features: [
			"Website Templates",
	...
	},
	{
		...
		description:
			"Complete travel advisor for guests with hotels, flights, car rentals, activities, and dining",
		icon: Plane,
	...
	},
	{
		...
		description:
			"Multi-channel advertising campaigns with advanced guest segmentation",
		icon: Target,
		category: "Marketing",
		features: [
			"Guest Segmentation",
			...
			"Email & SMS Marketing",
			"Physical Mail (Privacy Protected)",
			"Campaign Analytics",
			"ROI Tracking",
		],
		color: "bg-rose-500",
