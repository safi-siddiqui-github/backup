export type MockAttendingEvent = {
...
export const mockAttendingEvents: MockAttendingEvent[] = [
	// 🎯 JUDE ATTENDING - Dedicated test event with all 13 modules
	{
		...
		description:
			"This is Jude's dedicated testing event showcasing ALL 13 guest modules with comprehensive functionality. Perfect for testing and demonstrating the complete guest experience including RSVP, Ticketing, Announcements, Schedule, Seating, Photos, Travel, Games, Surveys, Networking, Food & Dining, and Merchandise.",
		startDate: new Date(),
			...
			tracks: [
				{
					...
					color: "#3B82F6",
					description: "Cutting-edge tech innovations",
				},
				{
					id: "business-1",
					name: "Business Strategy",
					color: "#10B981",
					description: "Strategic business approaches",
				},
				{
					id: "innovation-1",
					name: "Innovation & Design",
					color: "#F59E0B",
					description: "Creative innovation methods",
				},
			],
			registeredSessions: [
				"keynote-1",
	...
	// ⭐ TEST EVENT - Easy to find showcase for all new features
	{
		...
		description:
			"🎯 TESTING EVENT: This is your dedicated test event to showcase all guest module features including announcements, ticketing, RSVP, seating, media, games, surveys, and more. Use this event to test all changes.",
	...
	// SHOWCASE EVENT - Comprehensive example with all features
	{
		...
		description:
			"The ultimate showcase event featuring all available modules and interactions. Experience everything from multi-ticket management to interactive seating, comprehensive media galleries, surveys, games, and real-time announcements.",
		startDate: new Date("2025-06-15"),
		endDate: new Date("2025-06-17"),
		time: "8:00 AM",
		locations: [
			{
				name: "Grand Innovation Center",
				address: "1000 Tech Boulevard, San Francisco, CA 94105",
			},
			{
				name: "Networking Lounge",
				address: "1000 Tech Boulevard, San Francisco, CA 94105",
		...
		conferenceData: {
			tracks: [
				...
				},
				{
					...
					color: "#10B981",
					description: "Green tech and sustainable practices",
				},
				{
					id: "leadership",
					name: "Tech Leadership",
					color: "#F59E0B",
					description: "Leading teams in the digital age",
				},
				{
					id: "blockchain",
	...
	},
	{
		...
		description:
			"Join industry leaders for cutting-edge AI presentations, workshops, and networking opportunities.",
			...
			tracks: [
				{
					...
					color: "#3B82F6",
					description: "Latest in AI and ML technologies",
				},
				{
					id: "startup",
					name: "Startup Ecosystem",
					color: "#10B981",
					description: "Building and scaling startups",
				},
				{
					id: "future-tech",
					name: "Future Technologies",
					color: "#F59E0B",
					description: "Emerging tech trends",
				},
			],
	...
	},
	{
		...
		subcategory: "Wedding",
		description:
			"Join us for a beautiful wedding celebration with dinner, dancing, and unforgettable memories.",
		...
		locations: [
			{
				name: "Seaside Chapel",
				address: "789 Ocean View Drive, Monterey, CA 93940",
			},
			{
				name: "Reception Pavilion",
				address: "789 Ocean View Drive, Monterey, CA 93940",
			},
		],
		hostId: "host-2",
		...
		moduleUsage: {
			rsvp: {
				status: "attending",
				responses: { plusOnes: 1, dietaryRestrictions: "Vegetarian" },
			},
			seating: {},
	...
	},
	{
		...
		description:
			"Professional development summit focused on modern leadership strategies and executive skills.",
		...
		locations: [
			{
				...
				address: "123 Business Plaza, Chicago, IL 60611",
			},
			{
				name: "Networking Terrace",
				address: "123 Business Plaza, Chicago, IL 60611",
			},
		],
		hostId: "host-3",
	...
	},
	{
		...
		subcategory: "Music",
		description:
			"Three-day outdoor music festival featuring top artists, food trucks, and art installations.",
	...
	},
	{
		...
		description:
			"Connect with industry professionals in a relaxed evening atmosphere with cocktails and appetizers.",
	...
	},
	{
		...
		description:
			"Learn authentic Mediterranean cooking techniques with professional chef Maria Gonzalez.",
		startDate: new Date("2025-04-05"),
		endDate: new Date("2025-04-05"),
		time: "2:00 PM",
		locations: [
			{
				name: "Main Kitchen Studio",
				address: "123 Culinary Lane, San Diego, CA 92101",
			},
			{
				name: "Dining Room",
				address: "123 Culinary Lane, San Diego, CA 92101",
		...
		moduleUsage: {
			...
			surveys: {
				...
				pending: ["post-workshop-feedback"],
			},
		},
	},
	{
		...
		subcategory: "Sports",
		description:
			"Community charity run supporting local schools with prizes, refreshments, and family activities.",
		startDate: new Date("2025-05-17"),
		endDate: new Date("2025-05-17"),
		time: "8:00 AM",
		locations: [
			{
				name: "Starting Line - Central Park South",
				address: "Central Park South, New York, NY 10019",
			},
			{
				name: "Finish Line - Bethesda Fountain",
		...
		moduleUsage: {
			rsvp: {
				status: "attending",
				responses: { emergencyContact: "Jane Doe - 555-0123" },
			},
			seating: {},
			media: { photosUploaded: 0, albumAccess: false },
			games: { participated: [], points: 0 },
	...
	},
	{
		...
		description:
			'Exclusive opening night for "Visions of Tomorrow" contemporary art exhibition with artist meet & greet.',
	...
	},
	{
		...
		description:
			"Weekend wellness retreat focused on mindfulness, yoga practice, and connecting with nature.",
		...
		locations: [
			{
				name: "Mountain Lodge",
				address: "789 Peaceful Valley, Colorado, CO 80424",
			},
			{
	...
	},
	{
		...
		subcategory: "Gaming",
		description:
			"Celebrate independent game development with demos, tournaments, and developer talks.",
		...
		moduleUsage: {
			...
			games: {
				participated: ["indie-tournament", "dev-quiz"],
				points: 890,
				rank: 3,
			},
			surveys: { completed: [], pending: [] },
	...
	// ADVANCED CONFERENCE EVENTS FOR ATTENDING EXPERIENCE
	{
		...
		description:
			"Advanced multi-day quantum computing conference with cutting-edge research presentations, hands-on quantum labs, and certification pathways across 3 university locations.",
		...
		locations: [
			...
			{
				name: "MIT Quantum Engineering Lab",
				address: "77 Massachusetts Ave, Cambridge, MA 02139",
			},
			{
				name: "Google Quantum AI Campus",
				address: "1600 Amphitheatre Pkwy, Mountain View, CA 94043",
			},
			{
				name: "Princeton Quantum Institute",
				address: "Jadwin Hall, Princeton, NJ 08544",
			},
		],
		hostId: "host-conf-1",
		...
		moduleUsage: {
			...
			surveys: {
				completed: [],
				pending: ["pre-conference-knowledge-assessment"],
			},
		},
		conferenceData: {
			tracks: [
				{
					...
					color: "#3B82F6",
					description: "Theoretical quantum mechanics and information theory",
				},
				{
					id: "quantum-hardware",
					name: "Quantum Hardware & Systems",
					color: "#10B981",
					description: "Physical quantum computers and engineering",
				},
				{
				...
				},
				{
					...
					color: "#8B5CF6",
					description: "ML applications on quantum systems",
				},
				{
					id: "quantum-crypto",
					name: "Quantum Cryptography",
					color: "#EF4444",
					description: "Quantum security and cryptographic protocols",
				},
			],
			registeredSessions: [
	...
	},
	{
		...
		description:
			"Multi-continental climate conference connecting scientists, policymakers, and activists across 6 major cities with live sessions and collaborative action planning.",
		startDate: new Date("2025-08-10"),
		endDate: new Date("2025-08-13"),
		time: "6:00 AM",
		locations: [
			{
				name: "UN Climate Hub New York",
				address: "405 E 42nd St, New York, NY 10017",
			},
			{
				name: "European Climate Foundation (Brussels)",
				address: "Rue de la Science 23, 1040 Brussels, Belgium",
			},
			{
				name: "Climate Research Center (Sydney)",
				address: "Climate Change Research Centre, Sydney NSW 2052, Australia",
			},
			{
				name: "Arctic Research Station (Tromsø)",
				address: "University of Tromsø, 9037 Tromsø, Norway",
			},
			{
				name: "Amazon Research Institute (São Paulo)",
				address: "Instituto de Pesquisas Amazônicas, São Paulo, Brazil",
			},
		],
		hostId: "host-conf-2",
		...
		moduleUsage: {
			...
			games: { participated: [], points: 0 },
			surveys: {
				completed: ["climate-expertise-survey"],
				pending: ["action-commitment-form"],
			},
		},
		conferenceData: {
			tracks: [
				{
					...
					color: "#0EA5E9",
					description: "Latest climate research and predictive modeling",
				},
				{
					id: "renewable-energy",
				...
				},
				{
					...
					color: "#F59E0B",
					description: "International climate agreements and policy frameworks",
				},
				{
					id: "adaptation-resilience",
					name: "Adaptation & Resilience",
					color: "#8B5CF6",
					description: "Climate adaptation strategies and infrastructure",
				},
				{
					id: "carbon-economics",
					name: "Carbon Economics",
					color: "#EF4444",
					description: "Carbon markets, pricing, and economic impacts",
				},
				{
					id: "youth-activism",
					name: "Youth Climate Action",
					color: "#84CC16",
					description: "Young climate activists and grassroots movements",
				},
			],
			registeredSessions: [
	...
	},
	{
		...
		description:
			"Cutting-edge neuroscience conference featuring brain-computer interface demonstrations, neural implant workshops, and ethics discussions across top research hospitals.",
		startDate: new Date("2025-10-05"),
		endDate: new Date("2025-10-08"),
		time: "9:00 AM",
		locations: [
			{
				name: "Johns Hopkins Neuroscience Institute",
				address: "725 N Wolfe St, Baltimore, MD 21205",
			},
			{
			...
			},
			{
				...
				address: "1 Hacker Way, Fremont, CA 94538",
			},
			{
				name: "Max Planck Institute (Virtual)",
				address: "Remote participation from Frankfurt, Germany",
			},
		],
		hostId: "host-conf-3",
		...
		moduleUsage: {
			...
			games: { participated: [], points: 0 },
			surveys: {
				completed: ["ethics-training-module"],
				pending: ["post-demo-feedback"],
			},
		},
		conferenceData: {
			tracks: [
				{
					id: "bci-hardware",
					name: "BCI Hardware & Engineering",
					color: "#3B82F6",
					description: "Brain-computer interface hardware development",
				},
				{
					id: "neural-decoding",
					name: "Neural Signal Decoding",
					color: "#10B981",
					description: "Algorithms for interpreting neural signals",
				},
				{
					id: "clinical-applications",
					name: "Clinical Applications",
					color: "#F59E0B",
					description: "Medical applications of neurotechnology",
				},
				{
					id: "neuroethics",
					name: "Neuroethics & Society",
					color: "#EF4444",
					description: "Ethical implications of brain technology",
				},
				{
					id: "motor-restoration",
					name: "Motor Function Restoration",
					color: "#8B5CF6",
					description: "Restoring movement through neural interfaces",
				},
			],
			registeredSessions: [
	...
	},
	{
		...
		description:
			"Multi-location culinary conference featuring molecular gastronomy labs, sustainable cooking workshops, and chef collaborations across renowned culinary institutes.",
		...
		locations: [
			...
			{
				name: "Johnson & Wales Culinary School",
				address: "8 Abbott Park Pl, Providence, RI 02903",
			},
			{
				name: "Le Cordon Bleu (Remote)",
				address: "Virtual participation from Paris, France",
			},
			{
				name: "Michelin Star Test Kitchen",
				address: "Secret Location - Invitation Only",
			},
		],
		hostId: "host-conf-4",
		...
		moduleUsage: {
			...
			games: { participated: [], points: 0 },
			surveys: {
				completed: ["pre-conference-skills-assessment"],
				pending: ["sustainability-commitment"],
			},
		},
		conferenceData: {
			tracks: [
				{
					...
					color: "#8B5CF6",
					description: "Scientific cooking techniques and food chemistry",
				},
				{
					id: "sustainable-cuisine",
					name: "Sustainable Cooking",
					color: "#10B981",
					description: "Environmentally conscious culinary practices",
				},
				{
					id: "plant-based-innovation",
					name: "Plant-Based Innovation",
					color: "#84CC16",
					description: "Advanced plant-based cooking techniques",
				},
				{
					id: "fermentation-science",
					name: "Fermentation Science",
					color: "#F59E0B",
					description: "Traditional and modern fermentation methods",
				},
				{
					id: "culinary-technology",
					name: "Culinary Technology",
					color: "#3B82F6",
					description: "Technology integration in professional kitchens",
				},
				{
					id: "global-fusion",
					name: "Global Fusion Techniques",
					color: "#EF4444",
					description: "Cross-cultural culinary innovation",
				},
			],
			registeredSessions: [
