export const Routes = {
  ...
  web: {
    ...
    general: {
      ...
      eventsCreateBasic: "/events/create/basic",
      eventsCreatePhotos: "/events/create/photos",
      eventsCreateFeatures: "/events/create/features",
      eventsCreateOptional: "/events/create/optional",
  ...
  api: {
    web: {
      guest: {
        ...
        eventAgeRestrictionAll: "/web/guest/event-age-restriction/all",
        eventModuleAll: "/web/guest/event-module/all",
        eventFeatureTypeAll: "/web/guest/event-feature-type/all",

        eventModelAll: "/web/guest/event-model/all",
      },
      auth: {
        ...
        eventStore: "/web/auth/event-model/store",
      },
    },
  },
};
