...
import SortableBattleOfOpinionsItem from "./SortableBattleOfOpinionsItem";
import ImportTemplateDialog from "../ImportTemplateDialog";
import { BATTLE_OF_OPINIONS_PACKS } from "../game-data";

export type BattleOfOpinionsQuestion = {
	id: string;
	question: string;
	explanation: string;
...
function createEmptyQuestion(index: number): BattleOfOpinionsQuestion {
	return {
		id: `${Date.now()}-${index}`,
		question: "",
		explanation: "",
...
export default function BattleOfOpinionsBuilderBoard() {
	const [questions, setQuestions] = useState<BattleOfOpinionsQuestion[]>([
	...
	const onChangeQuestion = useCallback(
		(id: string, next: BattleOfOpinionsQuestion) => {
	...
	const handleImportTemplate = (template: any) => {
		// Convert template to BattleOfOpinionsQuestion format
		// This is a placeholder - actual conversion depends on template structure
		const newQuestions: BattleOfOpinionsQuestion[] = [];
