...
export default function ProposalDetailModal({
	...
	const [editedVendorName, setEditedVendorName] = useState(proposal.vendorName);
	const [editedTotalCost, setEditedTotalCost] = useState(proposal.totalCost);
	...
	const [editedSubmitted, setEditedSubmitted] = useState(proposal.submitted);
	...
	const handleSaveAndResend = () => {
		...
		if (!editedTimeline.trim()) {
			toast.error("Timeline summary required", {
				description:
					"Please describe the proposal timeline in the summary field.",
			});
			return;
		}
		...
		const updatedData: Partial<Proposal> = {
			...
			vendorCompany: editedVendorName,
		...
		// If onSaveEdit is provided, call it to create a new version
		if (onSaveEdit) {
			onSaveEdit(proposal.id, updatedData);
			...
			toast.success("Proposal Updated!", {
				description:
					"The edited proposal has been sent back to the vendor for review.",
				duration: 4000,
			});
		}
	...
	return (
		<>
			<Dialog open={open} onOpenChange={onOpenChange}>
				<DialogContent className="max-h-[90vh] max-w-5xl! overflow-y-auto !bg-white dark:!bg-[#020617] backdrop-blur-sm [background-color:rgb(255_255_255/0.98)] dark:[background-color:#020617]">
					<DialogHeader>
						<div className="flex items-center justify-between">
							<div className="flex items-center gap-2">
								<DialogTitle>Proposal Information</DialogTitle>
					...
					<div className="space-y-6">
								...
								<div>
									...
									{isEditMode ? (
										<Input
											...
											onChange={(e) =>
												setEditedTotalCost(Number(e.target.value))
											}
											className="mt-1"
											disabled
										/>
						...
						<div>
							...
							<div className="overflow-hidden rounded-lg border">
								<table className="w-full">
									<thead className="bg-muted dark:bg-[#020617]">
										<tr>
									...
									<tbody>
										...
										<tr className="border-t bg-muted dark:bg-[#020617] font-semibold">
															...
															<div className="flex flex-col">
																...
																<div className="flex flex-wrap items-center gap-3 text-xs text-muted-foreground sm:text-sm">
																	<div className="flex items-center gap-1">
																		...
																		<span>
																			{timeline.startDate || "No start date"}
																		</span>
																	</div>
																	<div className="flex items-center gap-1">
																		<Clock className="h-4 w-4" />
																		<span>
																			{timeline.dueDate || "No due date"}
																		</span>
																	</div>
													...
													<CardContent className="space-y-6 p-4 sm:p-6">
														{isEditMode ? (
															<div className="space-y-6">
																...
																<div className="grid gap-4 md:grid-cols-3">
																	...
																	<div className="flex flex-col gap-2">
																		...
																		<div className="flex items-center gap-3 rounded-lg border bg-muted/40 dark:bg-[#020617]/70 px-3 py-2">
																			<Switch
																...
																<div className="space-y-5">
																	{timeline.sections.map((section) => (
																		<Card
																			key={section.id}
																			className="border-dashed !bg-white dark:!bg-[#020617] backdrop-blur-sm [background-color:rgb(255_255_255/0.95)] dark:[background-color:#020617]"
																		>
																...
																<Button
																	...
																	variant="outline"
																	onClick={() =>
																		addSectionToTimeline(timeline.id)
																	}
																>
																	<Plus className="mr-2 h-4 w-4" />
																	Add Section
															...
															<div className="space-y-5">
																...
																{timeline.paymentRequired && (
																	<div className="rounded-lg border bg-muted/40 dark:bg-[#020617]/70 p-4">
																		<div className="flex items-center gap-2">
																...
																<div className="space-y-4">
																	{timeline.sections.map((section) => (
																		<div
																			key={section.id}
																			className="rounded-lg border bg-muted/40 dark:bg-[#020617]/70 p-4"
																		>
																			<div className="flex items-center gap-2">
																				<h5 className="text-sm font-semibold uppercase text-muted-foreground">
																					{section.heading}
						...
						<div>
							...
							{isEditMode ? (
								...
								<Card className="bg-muted dark:bg-[#020617]">
