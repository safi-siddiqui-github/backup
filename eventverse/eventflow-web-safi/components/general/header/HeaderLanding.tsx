...
export default function HeaderLanding() {
  return (
    <header className="w-full border border-white bg-white ml-4 lg:ml-0">
      <div className="mx-auto flex w-full max-w-none items-center justify-between px-6 py-4 xl:max-w-7xl xl:px-8">
        ...
        <div className="flex items-center space-x-3">
          ...
          <Link
            href="/create-event"
            className="flex items-center justify-center text-xs sm:text-sm font-medium text-white transition-colors hover:bg-purple-700 w-[120px] sm:w-[166px] h-[36px] sm:h-[48px]"
            style={{
              borderRadius: '40px',
