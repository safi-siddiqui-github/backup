...
import { MdCalendarToday, MdSearch, MdConfirmationNumber } from "react-icons/md";
      ...
      <div className="max-w-6xl mx-auto px-6 xl:px-8">
        ...
        <div className="flex justify-center items-center mb-8">
          <div className="flex -space-x-4">
            <div className="w-20 h-20 rounded-full overflow-hidden border-4 border-white shadow-lg transition-transform duration-300 hover:scale-110 hover:shadow-xl">
              <div 
                className="w-full h-full bg-cover bg-center bg-no-repeat"
                style={{ backgroundImage: `url('/featured3.png')` }}
              />
            </div>
            <div className="w-20 h-20 rounded-full overflow-hidden border-4 border-white shadow-lg z-10 transition-transform duration-300 hover:scale-110 hover:shadow-xl">
              <div 
                className="w-full h-full bg-cover bg-center bg-no-repeat"
