            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-center gap-4">
                ...
                <div className="w-full md:w-1/2 flex-shrink-0">
                  <div 
                    className="w-full h-40 md:h-48 rounded-2xl bg-cover bg-center bg-no-repeat transition-transform duration-300 hover:scale-105 hover:shadow-lg"
                    style={{
                ...
                <div className="w-full md:w-1/2 flex flex-col justify-center">
                  ...
                  <div className="flex items-center justify-between mt-4">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      >
                        <MdChevronLeft className="h-3 w-3 text-white" />
                      </button>
                      ...
                      <button
                        ...
                        className="w-6 h-6 rounded-full bg-white/20 hover:bg-white/30 transition-colors flex items-center justify-center"
                      >
                        <MdChevronRight className="h-3 w-3 text-white" />
                      </button>
                    </div>
                  </div>
                </div>
          ...
          <div className="w-full lg:w-1/2">
            <div className="max-w-2xl mx-auto lg:mx-0 pt-4">
              ...
              <div className="flex flex-col md:flex-row gap-4 items-start">
                ...
                {/* Conference Image */}
                <div 
                  className="w-full md:w-56 h-40 rounded-xl bg-cover bg-center bg-no-repeat flex-shrink-0 transition-transform duration-300 hover:scale-105 hover:shadow-lg"
                  style={{
