...
export default function WebHomeOrganizerComponent() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex flex-col gap-2 text-center">
        <HeadingTwoComponent>Organizers Following</HeadingTwoComponent>
        <p className="">
          Events from your favorite organizers, all in one place.
        </p>
      </div>
