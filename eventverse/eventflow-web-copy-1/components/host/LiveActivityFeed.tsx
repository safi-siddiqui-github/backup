        ...
        <ScrollArea className="h-80">
          <div className="space-y-3">
            {mockActivities.map((activity) => (
              <div
                key={activity.id}
                className="from-muted/30 to-muted/10 hover:from-muted/50 hover:to-muted/20 animate-fade-in flex items-start gap-3 rounded-lg bg-gradient-to-r p-3 transition-all duration-200"
              >
                <div
                ...
                <div className="min-w-0 flex-1">
                  ...
                  {activity.xpGained && activity.xpGained > 0 && (
                    <Badge className="mt-1 border-0 bg-gradient-to-r from-purple-500 to-blue-500 text-xs text-white">
