...
import { Calendar, CalendarClock, Clock, Plus, Type, X } from "lucide-react";
  ...
  const optionTypes = [
    {
      ...
      label: "Text Options",
      icon: Type,
      description: "Traditional text choices",
    },
    {
      value: "date",
      label: "Date Options",
      icon: Calendar,
      description: "Pick from different dates",
    },
    {
      value: "time",
      label: "Time Options",
      icon: Clock,
      description: "Pick from different times",
    },
    {
      value: "datetime",
      label: "Date & Time Options",
      icon: CalendarClock,
      description: "Pick from date-time combinations",
    },
  ];
    ...
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <Select
          value={optionType}
          onValueChange={(value) =>
            onOptionTypeChange(value as OptionInputsProps["optionType"])
          }
        >
          <SelectTrigger>
            <SelectValue />
            ...
            <div className="flex-1 space-y-2">
              ...
              {optionType === "date" && (
                <DateInput
                  ...
                  onChange={(date) =>
                    updateOption(index, { value: date || new Date() })
                  }
      ...
      <div className="bg-muted/50 rounded border p-3">
        ...
        <div className="space-y-2">
          {options.map((option, index) => (
            ...
            >
              <div className="border-muted-foreground h-3 w-3 rounded-full border"></div>
              <span>
