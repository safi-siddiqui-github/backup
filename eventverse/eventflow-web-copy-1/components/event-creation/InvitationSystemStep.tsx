...
const InvitationSystemStep = ({
  ...
  const [selectedTemplate, setSelectedTemplate] = useState(
    formData.invitationSettings?.template || "elegant",
  );
  const [customMessage, setCustomMessage] = useState(
    formData.invitationSettings?.customMessage || "",
  );
  const [sendTime, setSendTime] = useState<"now" | "scheduled">(
    formData.invitationSettings?.sendTime || "now",
  );
  const [scheduledDate, setScheduledDate] = useState<Date | undefined>();
  const [selectedMethods, setSelectedMethods] = useState<string[]>(
    formData.invitationSettings?.method || ["email"],
  );
  ...
  const invitationMethods = [
    ...
    },
    {
      ...
      name: "SMS",
      icon: MessageSquare,
      description: "Quick text message invites",
    },
    {
      id: "social",
      name: "Social Media",
    ...
    <div className="space-y-6 p-6">
      <div>
        ...
        <p className="mt-1 text-gray-600">
          Configure how you&apos;ll invite guests to your event
        </p>
      </div>
                ...
                {invitationTemplates.map((template) => (
                  ...
                  >
                    <div className="space-y-3">
                      ...
                      <div className="rounded bg-gray-100 p-3 text-sm text-gray-700">
                        {template.preview}
                      </div>
                    </div>
                  </button>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm text-gray-500">
                  This message will be included in your invitation along with
                  event details
                </p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="rounded-lg bg-gray-50 p-4 text-sm whitespace-pre-line text-gray-700">
                  {defaultMessage}
                </div>
              </div>
            ...
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex rounded-lg bg-gray-100 p-1">
                  ...
                  >
                    <CalendarIcon className="mx-auto mb-1 h-4 w-4" />
                    Schedule
                    <p className="mt-1 text-xs text-gray-500">
              ...
              <Card className="border-blue-200 bg-blue-50">
                <CardContent className="pt-6">
                  ...
                  <ul className="space-y-1 text-sm text-blue-700">
                    ...
                    <li>
                      • Follow up with reminder 1 week before RSVP deadline
                    </li>
