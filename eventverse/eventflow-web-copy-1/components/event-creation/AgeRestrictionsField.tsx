          ...
          <CardContent className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-2">
                {commonAgeRestrictions.map((preset, index) => (
                  <button
                    key={index}
                    type="button"
                    className="hover:bg-muted rounded-lg border p-3 text-left text-sm transition-colors"
                    onClick={() => {
                      if (preset.type === "none") {
                        handleUpdate({
                        ...
                        handleUpdate({
                          restrictionType:
                            preset.type as AgeRestrictionsData["restrictionType"],
                          minAge: preset.minAge,
                          maxAge: preset.maxAge,
                          requiresGuardian: preset.minAge
                            ? preset.minAge < 18
                            : false,
                        });
                      }
            ...
            <div className="border-t pt-4">
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      handleUpdate({
                        restrictionType:
                          value as AgeRestrictionsData["restrictionType"],
                      })
                    }
                  >
                ...
                {(localData.restrictionType === "minimum" ||
                  localData.restrictionType === "range" ||
                  localData.restrictionType === "exact") && (
                  <div>
                ...
                {(localData.restrictionType === "maximum" ||
                  localData.restrictionType === "range") && (
                  <div>
                ...
                <div className="flex items-center space-x-2">
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      handleUpdate({ requiresGuardian: checked })
                    }
                  />
                  <Label
                    htmlFor="requires-guardian"
                    className="text-sm"
                  >
