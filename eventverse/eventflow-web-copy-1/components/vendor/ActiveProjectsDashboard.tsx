...
const ActiveProjectsDashboard = ({ vendor }: ActiveProjectsDashboardProps) => {
  ...
  const upcomingMilestones = activeProjects.filter(
    (p) =>
                    ...
                    <div>
                      <div className="mb-2 flex items-center justify-between">
                        ...
                        <span className="text-sm text-gray-600">
                          {project.stageProgress}% Complete
                        </span>
                      </div>
                      <Progress
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-600">
                            Due:{" "}
                            {project.nextMilestoneDate.toLocaleDateString()}
                          </p>
                        </div>
                      </div>
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Track progress through your defined service stages
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
        ...
        >
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Latest messages and updates from your clients
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                  ...
                  .map((project) => (
                    ...
                    >
                      ...
                      <p className="mb-3 text-sm text-gray-600">
                        Latest message about{" "}
                        {project.currentStage.toLowerCase()} requirements...
                      </p>
                      <Button
                        variant="outline"
                        size="sm"
                ...
                {activeProjects.filter((p) => p.unreadMessages > 0).length ===
                  0 && (
