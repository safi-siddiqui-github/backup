    ...
    <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="flex items-center gap-1 text-xs text-green-600">
                  <TrendingUp className="h-3 w-3" />+{analytics.revenue.growth}%
                  from last month
                </p>
              </div>
              ...
              {monthlyData.map((data, index) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="min-w-[80px] text-right text-sm font-bold">
            ...
            <div className="space-y-4">
              <div className="rounded-lg border border-green-200 bg-green-50 p-4">
                ...
                <p className="text-sm text-green-700">
                  Your revenue increased by 50.6% this month. Keep up the
                  excellent work!
                </p>
              </div>
              ...
              <div className="rounded-lg border border-blue-200 bg-blue-50 p-4">
                ...
                <p className="text-sm text-blue-700">
                  Your 4.8-star rating is excellent. Consider showcasing more
              ...
              <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-4">
                ...
                <p className="text-sm text-yellow-700">
                  Respond to leads within 2 hours to increase conversion by up
                  to 30%.
                </p>
              </div>
              ...
              <div className="rounded-lg border border-purple-200 bg-purple-50 p-4">
                ...
                <p className="text-sm text-purple-700">
                  Wedding season is approaching. Consider updating your pricing
                  and availability.
                </p>
              </div>
            </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            How your vendor profile is performing
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-2 gap-6 md:grid-cols-4">
            ...
            <div className="text-center">
              <p className="text-3xl font-bold text-yellow-600">
                {analytics.profile.rating}
              </p>
              <p className="text-sm text-gray-600">Average Rating</p>
              <p className="text-xs text-gray-500">
                Based on {analytics.profile.reviews} reviews
              </p>
            </div>
            <div className="text-center">
