        ...
        <DialogHeader>
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="mt-1 text-gray-600">Client: {lead.clientName}</p>
            </div>
        ...
        >
          ...
          >
                ...
                <CardContent className="space-y-3">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {lead.clientEmail || "sarah@email.com"}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-gray-600">Phone:</span>
                    <span className="font-medium">
                      {lead.clientPhone || "+1 (555) 123-4567"}
                    </span>
                  </div>
                  <div className="flex justify-between">
            ...
            <Card>
              ...
              <CardContent>
                <p className="mb-4 text-gray-700">{lead.requirements}</p>
