...
import { Proposal } from "@/components/budget/ComprehensiveBudgetModule";
...
import { Brain, Calendar, DollarSign, FileText, Sparkles } from "lucide-react";
...
const AIProposalGenerator = ({ children }: AIProposalGeneratorProps) => {
  ...
  const handleGenerateProposal = async () => {
    ...
    const proposal = {
      ...
      breakdown: [
        {
          item: "Full Day Photography (8 hours)",
          quantity: 1,
          unitPrice: 3500,
          total: 3500,
        },
        ...
        {
          item: "Professional Editing (50 photos)",
          quantity: 1,
          unitPrice: 1200,
          total: 1200,
        },
        {
          item: "Wedding Album (Premium)",
          quantity: 1,
          unitPrice: 1500,
          total: 1500,
        },
        {
          item: "Online Gallery Access",
          quantity: 1,
          unitPrice: 300,
          total: 300,
        },
        {
          item: "USB Drive with All Photos",
          quantity: 1,
          unitPrice: 200,
          total: 200,
        },
        {
          item: "Second Photographer",
          quantity: 1,
          unitPrice: 1000,
          total: 1000,
        },
      ...
      terms:
        "50% deposit required to secure date, remaining balance due on wedding day. Travel within 50 miles included.",
      confidence: 94,
    };
    ...
    >
      ...
      <DialogContent className="max-h-[90vh] max-w-4xl overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Generate intelligent, customized proposals based on client
            requirements and your business data
          </DialogDescription>
        </DialogHeader>
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  ...
                  <div className="overflow-hidden rounded-lg border">
                    {generatedProposal?.breakdown?.map(
                      (item, index: number) => (
                        <div
                          key={index}
                    ...
                    <div className="bg-gray-50 p-3 text-lg font-bold">
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <ul className="space-y-1 text-sm text-gray-700">
                      {generatedProposal?.deliverables?.map(
