        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold">
                  {scheduleOverview.delayedEvents}
                </div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold">
                  {scheduleOverview.attendanceRate}%
                </div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold">
                  {scheduleOverview.totalDuration}min
                </div>
