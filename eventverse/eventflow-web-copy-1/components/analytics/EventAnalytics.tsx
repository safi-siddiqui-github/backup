...
import { Calendar, Camera, Clock, TrendingUp, Users } from "lucide-react";
import {
  Bar,
  BarChart,
  CartesianGrid,
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
        <Card className="border-l-4 border-l-green-500">
          <CardContent className="p-4">
            <h4 className="mb-2 font-medium text-green-700">Top Performing</h4>
            <p className="text-sm">
              RSVP module has 94% usage rate - highest guest engagement
            </p>
            <Badge
              variant="outline"
              className="mt-2"
        ...
        <Card className="border-l-4 border-l-yellow-500">
          <CardContent className="p-4">
            ...
            <p className="text-sm">
              Seating module usage is low at 38% - consider promoting features
            </p>
            <Badge
              variant="outline"
              className="mt-2"
        ...
        <Card className="border-l-4 border-l-blue-500">
          <CardContent className="p-4">
            <h4 className="mb-2 font-medium text-blue-700">Peak Activity</h4>
            <p className="text-sm">
              Highest engagement between 2-3 PM - optimal for announcements
            </p>
            <Badge
              variant="outline"
              className="mt-2"
