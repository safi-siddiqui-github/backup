...
import { Clock, Gamepad2, Star, Trophy, Users, Zap } from "lucide-react";
import {
  Bar,
  BarChart,
  CartesianGrid,
...
const GuestAnalytics = ({ eventId }: GuestAnalyticsProps) => {
  ...
  const gameParticipationData = [
    {
      game: "Love Story Trivia",
      participants: 156,
      avgScore: 847,
      completion: 94,
    },
    {
      game: "Photo Scavenger Hunt",
      participants: 134,
      avgScore: 723,
      completion: 87,
    },
    ...
    {
      game: "Wedding Facts Quiz",
      participants: 87,
      avgScore: 534,
      completion: 82,
    },
    {
      game: "Couple's Journey",
      participants: 76,
      avgScore: 678,
      completion: 90,
    },
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <Badge
                  ...
                  className="mt-1"
                >
                  {liveGameStats.peakConcurrent} peak players
                </Badge>
              </div>
            </div>
          </CardContent>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <Badge
                  ...
                  className="mt-1"
                >
                  {liveGameStats.completionRate}% completion
                </Badge>
              </div>
            </div>
          </CardContent>
        ...
        <CardContent>
          <div className="space-y-4">
            {topGamers.map((gamer, index) => (
              <div
                key={index}
                className="flex items-center justify-between rounded-lg border bg-gradient-to-r from-purple-50 to-pink-50 p-4"
              >
                <div className="flex items-center gap-3">
                  <div
