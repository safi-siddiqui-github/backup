...
import { Camera, Download, Eye, Heart, Image, Share2 } from "lucide-react";
import {
  Bar,
  BarChart,
  CartesianGrid,
              ...
              >
                ...
                <div className="flex items-center gap-6">
                  ...
                  <Badge variant="outline">
                    {Math.round((album.downloads / album.views) * 100)}%
                    download rate
                  </Badge>
                </div>
              </div>
