...
const AIExpensePlanner = ({
  ...
  useEffect(() => {
    const savedIds = localStorage.getItem(
      `ai-recommendations-added-${eventType}-${eventSize}`,
    );
    if (savedIds) {
      try {
  ...
  const generateComprehensiveRecommendations = (): AIRecommendation[] => {
    ...
    const essentialRecommendations = [
      {
        ...
        estimatedCost: Math.round(totalBudget * 0.3),
      ...
      },
      {
        ...
        description:
          "Comprehensive event insurance covering liability, cancellation, and vendor issues",
        estimatedCost: Math.round(totalBudget * 0.02),
        priority: "essential" as const,
        reasoning:
          "Event insurance protects against unexpected issues and is often required by venues.",
      ...
      },
      {
        ...
        description:
          "Required permits for music, alcohol service, and special events",
        estimatedCost: Math.round(totalBudget * 0.01),
        priority: "essential" as const,
        reasoning:
          "Legal compliance is essential for event operation and avoiding penalties.",
      ...
      },
      {
        ...
        description:
          "Clean, well-maintained restroom facilities with attendants",
        estimatedCost: Math.round(totalBudget * 0.03),
        priority: "essential" as const,
        reasoning:
          "Quality restroom facilities are essential for guest comfort and event success.",
      ...
      },
      {
        ...
        priority: "essential" as const,
        reasoning:
          "Backup power ensures uninterrupted service for critical equipment.",
        percentageOfBudget: 2,
        minGuestCount: 75,
      },
    ];
    ...
    const guestExperienceRecommendations = [
      {
        ...
        description:
          "Full event photography coverage with professional editing and digital gallery",
        estimatedCost: Math.round(totalBudget * 0.1),
        priority: "guest_experience" as const,
        reasoning:
          "Professional photography captures memories and provides lasting value for you and your guests.",
      ...
      },
      {
        ...
        subcategory:
          eventType === "Wedding" ? "DJ & Music" : "Professional Entertainment",
        title: `${eventType} Entertainment`,
        description:
          "Professional entertainment including sound system, music, and MC services",
        estimatedCost: Math.round(totalBudget * 0.08),
        priority: "guest_experience" as const,
        reasoning:
          "Quality entertainment keeps guests engaged and creates a memorable atmosphere.",
      ...
      },
      {
        ...
        description:
          "Complete bar service with professional bartenders and premium selection",
        estimatedCost: Math.round(totalBudget * 0.08),
        priority: "guest_experience" as const,
        reasoning:
          "Professional bar service enhances guest experience and ensures responsible service.",
        percentageOfBudget: 8,
        minGuestCount: 30,
      },
      {
        ...
        description:
          "Elegant welcome reception with cocktails and hors d'oeuvres",
        estimatedCost: Math.round(totalBudget * 0.06),
        priority: "guest_experience" as const,
        reasoning:
          "A welcome reception sets the tone and helps guests mingle comfortably.",
      ...
      },
      {
        ...
        description:
          "Assistance with hotel bookings and accommodation arrangements for out-of-town guests",
        estimatedCost: Math.round(totalBudget * 0.03),
        priority: "guest_experience" as const,
        reasoning:
          "Helping guests with accommodations shows thoughtfulness and improves attendance.",
        percentageOfBudget: 3,
        minGuestCount: 50,
      },
      {
        ...
        description:
          "Specialized menu options for dietary restrictions and preferences",
        estimatedCost: Math.round(totalBudget * 0.04),
        priority: "guest_experience" as const,
        reasoning:
          "Accommodating dietary needs ensures all guests can enjoy the meal.",
    ...
    const aestheticRecommendations = [
      {
        ...
        description:
          "Professional floral design including centerpieces, ceremony flowers, and ambient arrangements",
        estimatedCost: Math.round(totalBudget * 0.07),
        priority: "aesthetic" as const,
        reasoning:
          "Floral arrangements create ambiance and enhance the visual appeal of your event.",
      ...
      },
      {
        ...
        priority: "aesthetic" as const,
        reasoning:
          "Professional lighting transforms the venue and creates the desired mood.",
        percentageOfBudget: 4,
      },
      {
        id: "linens-decor",
        ...
        priority: "aesthetic" as const,
        reasoning:
          "Quality linens and table settings elevate the dining experience.",
        percentageOfBudget: 3,
      },
      {
        id: "ceiling-draping",
        ...
        description:
          "Elegant ceiling draping and fabric treatments to transform the space",
        estimatedCost: Math.round(totalBudget * 0.04),
        priority: "aesthetic" as const,
        reasoning:
          "Ceiling treatments create dramatic visual impact and soften harsh venue lighting.",
        percentageOfBudget: 4,
      },
      {
        id: "entrance-decor",
        ...
        description:
          "Professional entrance styling with welcome signage and decorative elements",
        estimatedCost: Math.round(totalBudget * 0.02),
        priority: "aesthetic" as const,
        reasoning:
          "First impressions matter - entrance décor sets expectations for the entire event.",
        percentageOfBudget: 2,
      },
    ];
    ...
    const operationalRecommendations = [
      {
        ...
        description:
          "Experienced coordinator to manage vendors and timeline on event day",
        estimatedCost: Math.round(totalBudget * 0.06),
        priority: "operational" as const,
        reasoning:
          "Professional coordination ensures smooth execution and allows you to enjoy your event.",
        percentageOfBudget: 6,
      },
      {
        ...
        description:
          "Shuttle service or transportation coordination for guests",
        estimatedCost: Math.round(totalBudget * 0.04),
        priority: "operational" as const,
        reasoning:
          "Guest transportation improves attendance and reduces parking concerns.",
        percentageOfBudget: 4,
        minGuestCount: 75,
      },
      {
        ...
        description:
          "Professional security personnel for guest safety and crowd management",
        estimatedCost: Math.round(totalBudget * 0.03),
        priority: "operational" as const,
        reasoning:
          "Security ensures guest safety and handles any issues discretely.",
        percentageOfBudget: 3,
        minGuestCount: 100,
      },
      {
        ...
        description:
          "Coordination of vendor meals, setup times, and service schedules",
        estimatedCost: Math.round(totalBudget * 0.02),
        priority: "operational" as const,
        reasoning:
          "Proper vendor coordination prevents delays and ensures smooth service.",
        percentageOfBudget: 2,
      },
    ];
    ...
    const enhancedRecommendations = [
      {
        ...
        description:
          "Professional videography with highlight reel and full ceremony coverage",
        estimatedCost: Math.round(totalBudget * 0.07),
        priority: "enhanced" as const,
        reasoning:
          "Videography captures the motion and emotion of your event in ways photos cannot.",
        percentageOfBudget: 7,
      },
      {
        id: "photo-booth",
        ...
        description:
          "Modern photo booth with props, instant prints, and digital sharing",
        estimatedCost: Math.round(totalBudget * 0.03),
        priority: "enhanced" as const,
        reasoning:
          "Photo booths provide entertainment and create memorable keepsakes for guests.",
        percentageOfBudget: 3,
      },
      {
        id: "welcome-gifts",
        ...
        priority: "enhanced" as const,
        reasoning:
          "Welcome gifts show appreciation and create a memorable first impression.",
        percentageOfBudget: 4,
      },
      {
        ...
        description:
          "Specialty interactive food station (e.g., taco bar, dessert station, coffee bar)",
        estimatedCost: Math.round(totalBudget * 0.04),
        priority: "enhanced" as const,
        reasoning:
          "Interactive food stations add entertainment value and dining variety.",
        percentageOfBudget: 4,
      },
      {
        ...
        description:
          "Casual late-night snacks and comfort food for extended celebrations",
        estimatedCost: Math.round(totalBudget * 0.03),
        priority: "enhanced" as const,
        reasoning:
          "Late-night snacks keep the energy up and extend the celebration.",
        percentageOfBudget: 3,
        minGuestCount: 50,
      },
      {
        ...
        description:
          "Custom signature cocktails designed specifically for your event",
        estimatedCost: Math.round(totalBudget * 0.02),
        priority: "enhanced" as const,
        reasoning:
          "Signature cocktails add a personal touch and create talking points.",
        percentageOfBudget: 2,
      },
      {
        id: "ambient-scenting",
      ...
      eventSpecificRecommendations.push(
        {
          ...
          priority: "enhanced" as const,
          reasoning:
            "A dedicated bridal suite provides privacy and convenience for wedding preparation.",
          percentageOfBudget: 3,
        ...
        },
        {
          ...
          description:
            "Live musicians for wedding ceremony (string quartet, pianist, etc.)",
          estimatedCost: Math.round(totalBudget * 0.04),
          priority: "guest_experience" as const,
          reasoning:
            "Live ceremony music creates an elegant and emotional atmosphere.",
          percentageOfBudget: 4,
          eventTypeSpecific: ["wedding"],
        },
        {
          ...
          priority: "essential" as const,
          reasoning:
            "The wedding cake is a traditional centerpiece and photo opportunity.",
          percentageOfBudget: 3,
          eventTypeSpecific: ["wedding"],
        },
      );
      ...
      eventSpecificRecommendations.push(
        {
          ...
          description:
            "Complete AV setup with screens, projectors, microphones, and tech support",
          estimatedCost: Math.round(totalBudget * 0.08),
          priority: "essential" as const,
          reasoning:
            "Professional AV equipment is crucial for corporate presentations and communication.",
          percentageOfBudget: 8,
        ...
        },
        {
          ...
          description:
            "Designated spaces for networking with comfortable seating and refreshments",
          estimatedCost: Math.round(totalBudget * 0.05),
          priority: "guest_experience" as const,
          reasoning:
            "Networking opportunities are a key value proposition for corporate events.",
        ...
        },
        {
          ...
          description:
            "Branded signage, name badges, folders, and promotional materials",
          estimatedCost: Math.round(totalBudget * 0.03),
          priority: "operational" as const,
          reasoning:
            "Branded materials reinforce company identity and professionalism.",
          percentageOfBudget: 3,
          eventTypeSpecific: ["corporate"],
        },
      );
      ...
      eventSpecificRecommendations.push(
        {
          ...
          description:
            "Personalized decorations matching the birthday theme and style",
          estimatedCost: Math.round(totalBudget * 0.06),
          priority: "aesthetic" as const,
          reasoning:
            "Themed decorations create a festive atmosphere and photo opportunities.",
          percentageOfBudget: 6,
        ...
        },
        {
          ...
          description:
            "Age-appropriate entertainment such as magicians, face painters, or performers",
          estimatedCost: Math.round(totalBudget * 0.08),
          priority: "guest_experience" as const,
          reasoning:
            "Special entertainment creates memorable moments and keeps guests engaged.",
          percentageOfBudget: 8,
          eventTypeSpecific: ["birthday"],
        },
        {
          ...
          priority: "enhanced" as const,
          reasoning:
            "Party favors provide lasting memories of the celebration.",
          percentageOfBudget: 4,
          eventTypeSpecific: ["birthday"],
        },
      );
    ...
    return baseRecommendations.filter((rec) => {
      ...
      if (rec.eventTypeSpecific && !rec.eventTypeSpecific.includes(eventLower))
        return false;
      return true;
    });
  };
    ...
    switch (priority) {
      ...
      case "guest_experience":
        return {
          ...
          description:
            "High-impact items that significantly enhance guest satisfaction",
        };
      case "aesthetic":
        return {
      ...
      case "operational":
        return {
          ...
          description:
            "Behind-the-scenes services that ensure smooth execution",
        };
      case "enhanced":
        return {
          ...
          description:
            "Premium upgrades and special touches that make your event memorable",
        };
      default:
        return {
          label: "Other",
    ...
    onAddExpenseItem({
      ...
      priority:
        recommendation.priority === "essential"
          ? "high"
          : recommendation.priority === "guest_experience"
            ? "high"
            : "medium",
      status: "planning",
      aiSuggested: true,
  ...
  const addCustomExpenseItem = () => {
    if (customItem.title && customItem.category && customItem.estimatedCost) {
      onAddExpenseItem({
        ...
        actualCost: 0,
        priority:
          customItem.priority === "essential" ||
          customItem.priority === "guest_experience"
            ? "high"
            : "medium",
        status: "planning",
        aiSuggested: false,
  ...
  const availableRecommendations = allRecommendations.filter((rec) => {
    ...
    console.log(
      `Recommendation ${rec.id}: ${isNotAdded ? "available" : "already added"}`,
    );
    return isNotAdded;
  });
  ...
  const filteredRecommendations =
    selectedPriorityFilter === "all"
      ...
      : availableRecommendations.filter(
          (rec) => rec.priority === selectedPriorityFilter,
        );
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="text-center">
            <Badge
              variant={budgetUtilization > 100 ? "destructive" : "outline"}
            >
        ...
        >
          ...
          <div className="mb-6 flex items-center gap-4">
            ...
            >
              ...
              <SelectContent>
                ...
                <SelectItem value="guest_experience">
                  Guest Experience
                </SelectItem>
          ...
          {isGenerating ? (
            <div className="py-12 text-center">
              <Sparkles className="mx-auto mb-4 h-16 w-16 animate-spin text-blue-500" />
              <h3 className="mb-2 text-lg font-medium text-gray-600">
                AI is analyzing your event...
              </h3>
              <p className="text-gray-500">
                Creating personalized budget recommendations
              </p>
            </div>
          ) : selectedPriorityFilter === "all" ? (
              ...
              {Object.entries(groupedRecommendations).map(
                ([priority, recommendations]) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`flex items-center gap-3 rounded-lg border-2 p-4 ${priorityInfo.bgColor} ${priorityInfo.borderColor}`}
                      >
                        <IconComponent
                        ...
                        <div>
                          <h3
                            className={`text-lg font-semibold ${priorityInfo.color}`}
                          >
                            {priorityInfo.label}
                          </h3>
          ...
          {expenseItems.length > 0 ? (
            ...
            <div className="py-12 text-center">
              ...
              <p className="mb-4 text-gray-500">
                Start by adding AI recommendations or create custom items
              </p>
            </div>
          )}
        </TabsContent>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(value: typeof customItem.priority) =>
