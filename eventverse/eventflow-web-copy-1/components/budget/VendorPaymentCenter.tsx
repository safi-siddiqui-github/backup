...
const VendorPaymentCenter = ({
  acceptedProposals,
  vendors,
  onProcessPayment,
}: VendorPaymentCenterProps) => {
          ...
          <div className="space-y-4">
            {payments.map((payment) => {
              ...
              return (
                <div
                  key={payment.id}
                  className={`rounded-lg border p-4 ${isOverdue ? "border-red-200 bg-red-50" : ""}`}
                >
                      ...
                      <div className="grid grid-cols-1 gap-4 text-sm md:grid-cols-3">
                        <div>
                          ...
                          <div className="font-medium">
                            {proposal?.title || "Unknown Service"}
                          </div>
                        </div>
                        <div>
                        ...
                        <div>
                          ...
                          <div className="font-medium">
                            ...
                            {payment.status === "pending" && (
                              <span
                                className={`ml-2 ${isOverdue ? "text-red-600" : "text-orange-600"}`}
                              >
                                (
                                {isOverdue
                                  ? `${Math.abs(daysUntilDue)} days overdue`
            ...
            <div className="space-y-4">
              <div className="rounded-lg bg-gray-50 p-4">
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <div className="font-medium">
                      {getVendorById(selectedPayment.vendorId)?.name}
                    </div>
                  </div>
                  <div>
              ...
              <div className="rounded-lg bg-blue-50 p-4">
                ...
                <p className="text-sm text-blue-700">
                  This payment will be processed through your connected Stripe
                  account. You will receive a receipt and the vendor will be
      ...
      {payments.length === 0 && (
        <div className="py-12 text-center">
          ...
          <p className="text-gray-500">
            Payments will appear here once you accept vendor proposals
          </p>
        </div>
      )}
    </div>
