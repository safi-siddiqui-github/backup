...
const ShowcaseEventTypes = ({
  selectedEventType,
  onEventTypeChange,
}: ShowcaseEventTypesProps) => {
  ...
  const selectedDetails =
    eventTypeDetails.find((e) => e.id === selectedEventType) ||
    eventTypeDetails[0];
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
        {eventTypeDetails.map((eventType) => (
          <Card
            key={eventType.id}
            className={`flex h-full cursor-pointer flex-col transition-all duration-200 hover:scale-[1.02] hover:shadow-lg ${
          ...
          >
            <CardHeader className="flex-shrink-0 pb-3 text-center">
              <div className="mb-3 flex justify-center">
                <div className="rounded-full bg-purple-100 p-3">
                  <eventType.icon className="h-6 w-6 text-purple-600" />
                </div>
              </div>
            ...
            <CardContent className="flex flex-1 flex-col justify-between pt-0 text-center">
      ...
      <Card className="overflow-hidden">
        <CardHeader className="bg-gradient-to-r from-purple-50 to-blue-50">
          <CardTitle className="flex items-center gap-3">
            <selectedDetails.icon className="h-6 w-6 text-purple-600" />
            ...
            <div>
              ...
              <div className="space-y-3">
                {selectedDetails.sampleSchedule.map((item, index) => (
                  ...
                  >
                    <div className="min-w-[80px] text-sm font-medium text-purple-600">
                      {item.time}
                    </div>
