...
const ConferenceGuestSchedule = ({
  event,
  guest,
}: ConferenceGuestScheduleProps) => {
  ...
  const mockSessions: ConferenceSession[] = useMemo(
    () => [
      // Day 1 - September 10
      {
        id: "keynote-1",
      ...
      },
      {
        ...
        description:
          "Building scalable real-time data processing systems using Kafka and stream processing.",
      ...
      },
      {
        ...
        description:
          "Industry leaders discuss the evolution of remote work culture and its impact on technology teams.",
      ...
      // Day 2 - September 11
      {
        ...
        description:
          "Breakthrough developments in quantum computing and their practical applications in enterprise environments.",
      ...
      },
      {
        ...
        description:
          "Advanced techniques for customizing large language models for specific business use cases.",
      ...
      },
      {
        ...
        description:
          "Advanced PWA techniques including offline synchronization, push notifications, and performance optimization.",
      ...
      },
      {
        ...
        description:
          "Best practices for designing and managing applications across multiple cloud providers.",
      ...
      // Day 3 - September 12
      {
        ...
        description:
          "How technology companies are leading the charge in environmental sustainability and green computing.",
      ...
      },
      {
        ...
        description:
          "Creating intelligent, interactive data visualizations using machine learning and modern web technologies.",
      ...
      },
      {
        ...
        description:
          "Comprehensive strategies for securing APIs in distributed microservice architectures.",
  ...
  const filteredSessions = useMemo(() => {
    return mockSessions.filter((session) => {
      ...
      const matchesTrack =
        filterTrack === "all" || session.track === filterTrack;
      const matchesLevel =
        filterLevel === "all" || session.level === filterLevel;

      return matchesSearch && matchesTrack && matchesLevel;
    });
  }, [mockSessions, searchTerm, filterTrack, filterLevel]);
  ...
  const renderSessionCard = (session: ConferenceSession, compact = false) => {
    ...
    return (
      <Card
        key={session.id}
        className={`${compact ? "p-3" : "p-4"} ${isSelected ? "bg-purple-50 ring-2 ring-purple-500" : ""}`}
      >
        <CardContent className="p-0">
          <div className="mb-2 flex items-start justify-between">
            <div className="flex-1">
              ...
              <p
                className={`text-gray-600 ${compact ? "text-xs" : "text-sm"} mb-2`}
              >
                {session.description}
              </p>

              <div className="mb-2 flex flex-wrap items-center gap-2">
                <Badge className={`${session.trackColor} text-xs text-white`}>
                  {session.track}
                </Badge>
                <Badge
                  variant="outline"
            ...
            <div className="flex flex-col items-end gap-2">
              <Button
                size="sm"
                variant={
                  isSelected ? "destructive" : isFull ? "secondary" : "default"
                }
      ...
      <div className="text-center">
        ...
        <div className="mt-4 flex items-center justify-center gap-4">
          ...
          <Badge variant="outline">
            {mySchedule.length > 0 ? "Schedule created" : "No sessions yet"}
          </Badge>
        </div>
      </div>
            ...
            <Card className="p-8 text-center">
              <CardContent className="p-0">
                ...
                <p className="mb-4 text-gray-600">
                  Browse sessions and add them to create your personalized
                  schedule
                </p>
