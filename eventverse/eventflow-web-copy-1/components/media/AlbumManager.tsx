      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600">
            Organize your event photos into collections
          </p>
        </div>
        <Dialog
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
        <Card className="bg-gradient-to-br from-blue-50 to-blue-100">
          <CardContent className="p-4 text-center">
            <FolderOpen className="mx-auto mb-2 h-8 w-8 text-blue-600" />
        ...
        <Card className="bg-gradient-to-br from-green-50 to-green-100">
          <CardContent className="p-4 text-center">
            <Camera className="mx-auto mb-2 h-8 w-8 text-green-600" />
            <div className="text-2xl font-bold text-green-900">
              {albums.reduce(
                (sum, album) => sum + album.photoCount + album.videoCount,
                0,
              )}
            </div>
          ...
          <div className="grid grid-cols-1 gap-6 text-sm text-gray-600 md:grid-cols-2">
            <div>
              ...
              <ul className="space-y-1">
                <li>
                  • Create albums by event segments (arrival, activities, etc.)
                </li>
