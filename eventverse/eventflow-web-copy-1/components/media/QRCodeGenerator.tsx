...
import { Copy, Download, Eye, QrCode, Settings } from "lucide-react";
...
const QRCodeGenerator = ({ eventId }: QRCodeGeneratorProps) => {
  ...
  const createQRCode = () => {
    ...
    const baseUrl =
      "https://90ebe2cd-fff8-4ed4-afa3-ba9cf6ca4d8f.lovableproject.com/media";
    let url = baseUrl;
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-600">
            Generate QR codes for easy guest photo sharing
          </p>
        </div>
        <Dialog
          ...
          <DialogContent>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  value={newQRType}
                  onValueChange={(value: QRCodeData["type"]) =>
                    setNewQRType(value)
                  }
                >
                  <SelectTrigger>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        {qrCodes.map((qr) => (
          <Card
            key={qr.id}
            className={`${qr.isActive ? "" : "opacity-60"}`}
          >
            <CardHeader className="pb-3">
              <div className="flex items-start justify-between">
                <div>
                  ...
                  <span
                    className={`mt-1 inline-block rounded-full px-2 py-1 text-xs font-medium ${getTypeColor(qr.type)}`}
                  >
                    {qr.type.replace("-", " ")}
                  </span>
                </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="text-center">
                <p className="mb-2 text-sm text-gray-600">{qr.description}</p>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
            <div>
              <h4 className="mb-2 font-medium">For Event Organizers:</h4>
            ...
            <div>
              <h4 className="mb-2 font-medium">For Guests:</h4>
              <ul className="space-y-1 text-sm text-gray-600">
