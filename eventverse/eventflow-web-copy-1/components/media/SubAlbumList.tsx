...
import { Camera, Edit, FolderOpen, Plus, Trash, Users } from "lucide-react";
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Let guests download from this album
                    </p>
                  </div>
                  <Switch
      ...
      <CardContent>
        {mainAlbum.subAlbums.length === 0 ? (
          <div className="py-8 text-center text-gray-500">
            ...
            <p>
              No sub-albums yet. Create your first sub-album to get started!
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            {mainAlbum.subAlbums.map((subAlbum) => (
              <Card
                key={subAlbum.id}
                className={`${subAlbum.isActive ? "" : "opacity-60"}`}
              >
                <CardHeader className="pb-3">
                  <div className="flex items-start justify-between">
                    ...
                    <Badge
                      variant={subAlbum.isActive ? "default" : "secondary"}
                      className="text-xs"
                    >
                ...
                <CardContent className="space-y-3">
                  <div className="flex justify-between text-sm">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span>{subAlbum.contributors}</span>
                    </div>
