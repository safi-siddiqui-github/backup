    ...
    const interval = setInterval(() => {
      ...
      if (Math.random() > 0.7) {
        const newPhoto: LivePhoto = {
          ...
          comments: 0,
          isNew: true,
          album: ["Reception", "Activities", "Venue"][
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">
                Real-time photos from your event • Last updated:{" "}
          ...
          photos.map((photo) => (
            <Card
              ...
              className={`transition-all hover:shadow-lg ${
                photo.isNew ? "ring-opacity-50 ring-2 ring-blue-500" : ""
              }`}
            >
              <CardContent className="p-4">
                <div className="flex gap-4">
                  ...
                  <div className="relative">
                    ...
                    />
                    {photo.isNew && (
                      <Badge className="absolute -top-2 -right-2 bg-blue-500 px-1 text-xs text-white">
                        New!
                      </Badge>
                    )}
                  </div>
                  ...
                  <div className="flex-1 space-y-2">
                    <div className="flex items-start justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          {formatTimeAgo(photo.uploadTime)}
                        </p>
                        {photo.album && (
                          <Badge
                            variant="secondary"
                    ...
                    <div className="flex gap-4 pt-2">
                      ...
                      <Button
                        ...
                        className="h-8 px-2 text-green-500 hover:bg-green-50 hover:text-green-600"
                      >
