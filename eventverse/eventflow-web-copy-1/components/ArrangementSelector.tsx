...
import { SeatingArrangement } from "@/types/venue";
import {
  Calendar,
  ChevronDown,
  MoreHorizontal,
...
const ArrangementSelector = () => {
  ...
  const [newVenueType, setNewVenueType] = useState<
    "table-based" | "seat-based"
  >("table-based");
  const [arrangementToDelete, setArrangementToDelete] =
    useState<SeatingArrangement | null>(null);

  if (
    !selectedLocationId ||
    !currentLocationData ||
    !currentLocationData.currentSection
  ) {
    return (
        ...
        {currentSection.arrangements.length === 0 ? (
          <div>
            ...
            <p className="text-sm text-gray-500">
              Add your first arrangement to get started
            </p>
          </div>
        ) : (
          <div className="flex items-center gap-2">
            <DropdownMenu>
              ...
              <DropdownMenuContent
                ...
                className="w-64"
              >
                {currentSection.arrangements.map(
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-gray-500">
                          {arrangement.venueType === "table-based"
                            ? "Table-based"
                            : "Seat-based"}
                        </div>
                      </div>
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Select
                value={newVenueType}
                onValueChange={(value: "table-based" | "seat-based") =>
                  setNewVenueType(value)
                }
              >
                <SelectTrigger>
                  <SelectValue />
                ...
                <SelectContent>
                  <SelectItem value="table-based">
                    Table-based (Round tables, rectangular tables)
                  </SelectItem>
                  <SelectItem value="seat-based">
                    Seat-based (Individual seats, theater style)
                  </SelectItem>
                </SelectContent>
              </Select>
            </div>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              &quot;? All guest assignments will be lost. This action cannot be
              undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
