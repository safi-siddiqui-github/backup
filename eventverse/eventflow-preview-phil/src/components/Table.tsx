...
const Table = ({
  ...
  return (
    <div
      ...
      onClick={handleClick}
      className={`absolute cursor-pointer border-2 bg-white rounded-lg shadow-sm hover:shadow-md transition-all ${
        isSelected ? 'border-blue-500 ring-2 ring-blue-200' : 'border-gray-300'
      } ${table.shape === 'round' ? 'rounded-full' : ''}`}
      style={{
        left: table.x,
        top: table.y,
        width: table.shape === 'round' ? 80 : table.shape === 'long-rectangular' ? 120 : 100,
