...
interface ContentBlockLibraryProps {
  onAddSection: (sectionType: SectionType, content: any) => void;
}

export const ContentBlockLibrary = ({ onAddSection }: ContentBlockLibraryProps) => {
  const contentBlocks: ContentBlock[] = [
        ...
        sessions: [
          {
            ...
            speakerBio: 'Leading technology researcher and innovation strategist',
            startTime: '09:00',
            endTime: '10:00',
            date: '2024-03-15',
            location: 'Main Auditorium',
        ...
        testimonials: [
          {
            ...
            company: 'StartupCo',
            content: 'This event exceeded my expectations! The speakers were incredible and I made valuable connections.',
          ...
          },
          {
            ...
            company: 'TechFirm',
            content: 'Great organization, excellent content, and perfect networking opportunities. Will definitely attend next year!',
    ...
    },
    {
      ...
      defaultContent: {
        ...
        description: 'Meet fellow attendees and expand your professional network'
      },
      defaultStyling: {
        padding: '4rem 0',
        backgroundColor: 'hsl(var(--muted)/0.3)'
  ...
  const getIcon = (iconName: string) => {
    const icons: Record<string, any> = {
      Layout, Type, Image, Mail, Calendar, Users, CreditCard, MapPin, Clock, Star, Heart, Camera,
      Grid3x3, UserCheck, DollarSign, CalendarDays, Hash, MessageSquare, Award, Building, Play, Network
    };
  ...
  return (
    <div className="space-y-6">
      ...
      {categories.map(category => {
        const blocks = contentBlocks.filter(block => block.category === category.id);
              ...
              {blocks.map(block => (
                <Card 
                  ...
                  className={`cursor-pointer hover:shadow-md transition-shadow border-dashed border-2 hover:border-solid ${
                    block.isPremium ? 'bg-gradient-to-br from-yellow-50 to-orange-50 border-yellow-200' : ''
                  }`}
      ...
      <div className="pt-4 border-t">
        <p className="text-xs text-muted-foreground">
          💡 Tip: Click on any block to add it to your page. You can customize it after adding.
        </p>
      </div>
    </div>
  );
