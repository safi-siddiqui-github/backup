...
const EventSearchFilters = ({ onClose, onFiltersChange }: EventSearchFiltersProps) => {
  ...
  const categories = [
    "Entertainment", "Business", "Education", "Sports", 
    "Food & Drink", "Arts & Culture", "Health & Wellness", "Technology"
  ];

  const types = [
    "Conference", "Workshop", "Concert", "Festival", "Networking",
    "Seminar", "Exhibition", "Party", "Competition", "Charity"
  ];
