...
export interface GameTemplate {
  id: string;
  title: string;
  type: "trivia" | "poll" | "icebreaker" | "scavenger" | "photo-challenge" | "prediction" | "team-activity" | "voting" | "word-game";
  category: "engagement" | "social" | "competitive" | "creative" | "educational" | "seasonal";
  description: string;
...
export const expandedGameTemplates: GameTemplate[] = [
  // TRIVIA GAMES
  {
    ...
    popularity: 95,
    questions: [
      { text: "Where did the couple first meet?", options: ["Coffee shop", "University", "Work", "Dating app"], correct: 1 },
      { text: "What's their favorite vacation destination?", options: ["Beach", "Mountains", "City", "Countryside"], correct: 0 }
    ],
  ...
  },
  {
    ...
    popularity: 87,
    questions: [
      { text: "What year was the company founded?", options: ["2010", "2012", "2015", "2018"], correct: 2 },
      { text: "How many offices do we have globally?", options: ["5", "8", "12", "15"], correct: 1 }
    ],
  ...
  },
  {
    ...
    popularity: 92,
    questions: [
      { text: "Which movie won the Oscar for Best Picture in 2023?", options: ["Top Gun", "Everything Everywhere", "Avatar", "Elvis"], correct: 1 }
    ],
    settings: { timeLimit: 30, showLeaderboard: true }
  },
  ...
  },
  {
    ...
    icon: "MapPin",
    popularity: 76,
    settings: { allowAnonymous: true, categories: ["books", "music", "tools", "food"] }
  },
  {
  ...
  // PHOTO CHALLENGES
  {
    ...
    settings: { 
      challenges: [
        "Something red", "A group selfie", "Your favorite food", "A sunset view"
      ],
  ...
  },
  {
    ...
    icon: "ArrowRightLeft",
    popularity: 78,
    settings: { themes: ["morning vs evening", "formal vs casual", "then vs now"] }
  },
  {
    id: "emoji-recreation",
  ...
  // TEAM ACTIVITIES
  {
    ...
    settings: { 
      bingoItems: [
        "Has traveled to 3+ countries", "Speaks 2+ languages", "Has a pet",
        "Born in a different state", "Plays an instrument"
      ]
    }
  },
  {
    ...
    icon: "BookOpen",
    popularity: 82,
    settings: { maxSentenceLength: 100, storyPrompts: ["adventure", "mystery", "comedy"] }
  },
  ...
  },
  {
    ...
    settings: { 
      predictions: [
        "How many kids will they have?", "Where will they honeymoon?", 
        "What will be their first pet?", "Anniversary celebration idea?"
      ]
    }
  },
  ...
  // VOTING GAMES
  {
    ...
    settings: { 
      categories: [
        "Most likely to become famous", "Best dressed", "Funniest person",
        "Most adventurous", "Best dancer"
      ]
    }
  },
  {
    ...
    icon: "Image",
    popularity: 83,
    settings: { maxVotesPerPerson: 3, categories: ["most creative", "funniest", "best quality"] }
  },
  ...
  // SEASONAL GAMES
  {
    ...
    icon: "Gift",
    popularity: 81,
    settings: { holidays: ["christmas", "halloween", "thanksgiving", "new_year"] }
  },
  {
    ...
    settings: { 
      activities: [
        "Beach volleyball", "Road trip", "Music festival", "Camping",
        "Water sports", "Outdoor concerts"
      ]
    }
  }
];
...
export const getFeaturedGames = () => 
  expandedGameTemplates.filter(game => game.featured).sort((a, b) => (b.popularity || 0) - (a.popularity || 0));
