...
import { Camera, Upload, Globe, Linkedin, Twitter, Instagram, Facebook, Plus, X, User, Briefcase, Link } from "lucide-react";
...
const ProfileEditDialog = ({ open, onClose }: ProfileEditDialogProps) => {
  ...
  const industries = [
    ...
    "Hospitality", "Non-profit", "Government", "Retail", "Manufacturing", "Other"
  ];
  ...
  const eventTypes = [
    "Corporate Events", "Weddings", "Conferences", "Trade Shows", "Social Events",
    "Fundraisers", "Product Launches", "Team Building", "Workshops", "Festivals"
  ];
  ...
  const handlePhotoUpload = (event: React.ChangeEvent<HTMLInputElement>, type: 'profile' | 'cover') => {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <Tabs defaultValue="profile-type" className="w-full">
          ...
          <TabsContent value="profile-type" className="space-y-6 mt-6">
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-4 border rounded-lg bg-gradient-to-br from-blue-50 to-indigo-50">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Share your personal interests, hobbies, and social connections. 
                    Perfect for casual events and building personal relationships.
                  </p>
                ...
                <div className="p-4 border rounded-lg bg-gradient-to-br from-purple-50 to-pink-50">
                  ...
                  <p className="text-sm text-muted-foreground mb-4">
                    Showcase your business credentials, expertise, and professional 
                    achievements. Ideal for corporate events and client relationships.
                  </p>
                  <ul className="text-sm space-y-1">
              ...
              <div className="p-4 bg-gradient-to-r from-violet-50 to-purple-50 rounded-lg border border-violet-200">
                ...
                <p className="text-sm text-muted-foreground mb-3">
                  Connect your LinkedIn and Instagram profiles to automatically import 
                  professional information and showcase your visual portfolio.
                </p>
                <Button 
          ...
          <TabsContent value="basic" className="space-y-6 mt-6">
            ...
            <div>
              ...
              <div className="relative h-32 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg overflow-hidden">
                ...
                <label className="absolute top-2 right-2 bg-black/50 text-white p-2 rounded-full cursor-pointer hover:bg-black/70 transition-colors">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => setFormData({ ...formData, yearsHosting: parseInt(e.target.value) || 0 })}
                  placeholder="0"
                  min="0"
                />
              </div>
          ...
          <TabsContent value="organizer" className="space-y-6 mt-6">
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between p-4 bg-gradient-to-r from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
                <div>
                  <h3 className="font-semibold text-foreground">Become a Public Event Organizer</h3>
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setFormData({ ...formData, isPublicOrganizer: checked })}
                />
              </div>
                ...
                <div className="space-y-6 animate-in slide-in-from-top-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setFormData({
                            ...formData,
                            organizerProfile: { ...formData.organizerProfile, businessName: e.target.value }
                          })}
                      ...
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) => setFormData({
                            ...formData,
                            organizerProfile: { ...formData.organizerProfile, businessLicense: e.target.value }
                          })}
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) => setFormData({
                          ...formData,
                          organizerProfile: { ...formData.organizerProfile, insuranceInfo: e.target.value }
                        })}
                      ...
                      {eventTypes.map((type) => (
                        <div key={type} className="flex items-center space-x-2">
                          <input
                            type="checkbox"
                            id={`eventType-${type}`}
                            checked={formData.organizerProfile.eventTypes.includes(type)}
                            onChange={(e) => {
                              const updatedTypes = e.target.checked
                                ? [...formData.organizerProfile.eventTypes, type]
                                : formData.organizerProfile.eventTypes.filter(t => t !== type);
                              setFormData({
                                ...formData,
                                organizerProfile: { ...formData.organizerProfile, eventTypes: updatedTypes }
                              });
                            }}
                            className="rounded"
                          />
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mb-2">
                      Add the locations where you provide event organizing services
                    </p>
                    <div className="space-y-2">
                      {formData.organizerProfile.serviceAreas.map((area, index) => (
                        <div key={index} className="flex gap-2">
                          <Input
                            value={area}
                            onChange={(e) => {
                              const newAreas = [...formData.organizerProfile.serviceAreas];
                              newAreas[index] = e.target.value;
                              setFormData({
                                ...formData,
                                organizerProfile: { ...formData.organizerProfile, serviceAreas: newAreas }
                              });
                            }}
                          ...
                          <Button
                            ...
                            size="sm"
                            onClick={() => {
                              const newAreas = formData.organizerProfile.serviceAreas.filter((_, i) => i !== index);
                              setFormData({
                                ...formData,
                                organizerProfile: { ...formData.organizerProfile, serviceAreas: newAreas }
                              });
                        ...
                        onClick={() => {
                          setFormData({
                            ...
                            organizerProfile: {
                              ...
                              serviceAreas: [...formData.organizerProfile.serviceAreas, '']
                            }
                          });
                        }}
                      >
                    ...
                    <div className="grid grid-cols-3 gap-4 mt-2">
                      <div>
                        ...
                        <Input
                          id="minPrice"
                          type="number"
                          value={formData.organizerProfile.priceRange?.min || ''}
                          onChange={(e) => setFormData({
                            ...formData,
                            organizerProfile: {
                              ...formData.organizerProfile,
                      ...
                      <div>
                        ...
                        <Input
                          id="maxPrice"
                          type="number"
                          value={formData.organizerProfile.priceRange?.max || ''}
                          onChange={(e) => setFormData({
                            ...formData,
                            organizerProfile: {
                              ...formData.organizerProfile,
                      ...
                      <div>
                        ...
                        <Select
                          value={formData.organizerProfile.priceRange?.currency || 'USD'}
                          onValueChange={(value) => setFormData({
                            ...formData,
                            organizerProfile: {
                              ...formData.organizerProfile,
                              priceRange: { ...formData.organizerProfile.priceRange, currency: value }
                            }
                          })}
                        >
                          <SelectTrigger>
                  ...
                  {/* Booking Preferences */}
                  <div className="space-y-4">
                    <h4 className="font-medium text-foreground">Booking Preferences</h4>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        <Label htmlFor="advanceBooking">Advance Booking Required (Days)</Label>
                        <Input
                          id="advanceBooking"
                          type="number"
                          value={formData.organizerProfile.bookingPreferences?.advanceBookingDays || ''}
                          onChange={(e) => setFormData({
                            ...formData,
                            organizerProfile: {
                              ...formData.organizerProfile,
                      ...
                      <div className="flex items-center space-x-2 mt-6">
                        <input
                          type="checkbox"
                          id="depositRequired"
                          checked={formData.organizerProfile.bookingPreferences?.depositRequired || false}
                          onChange={(e) => setFormData({
                            ...formData,
                            organizerProfile: {
                              ...formData.organizerProfile,
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        value={formData.organizerProfile.bookingPreferences?.cancellationPolicy || ''}
                        onChange={(e) => setFormData({
                          ...formData,
                          organizerProfile: {
                            ...formData.organizerProfile,
          ...
          <TabsContent value="social" className="space-y-6 mt-6">
            <Button 
              onClick={() => setShowSocialDialog(true)}
              className="w-full bg-gradient-to-r from-violet-600 to-purple-600 hover:opacity-90 mb-6"
            >
              <Link className="w-4 h-4 mr-2" />
              Manage Social Integrations
            </Button>
            ...
            <div className="space-y-4">
              ...
              <div className="relative">
                <Facebook className="absolute left-3 top-1/2 transform -translate-y-1/2 text-blue-700 w-4 h-4" />
                <Input
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked) => setFormData({
                    ...formData,
                    notificationPreferences: { ...formData.notificationPreferences, push: checked }
                  })}
                />
              </div>
            </div>
