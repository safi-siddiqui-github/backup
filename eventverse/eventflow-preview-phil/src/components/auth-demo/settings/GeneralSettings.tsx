  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Manage your organization's basic information and preferences.</p>
      </div>
        ...
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select value={settings.type} onValueChange={(value) => 
                setSettings(prev => ({ ...prev, type: value as "business" | "enterprise" }))
              }>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
