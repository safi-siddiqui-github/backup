...
export const StandaloneSignupModal = ({ isOpen, onClose }: StandaloneSignupModalProps) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle className="text-center">Enhanced Authentication System</DialogTitle>
        </DialogHeader>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          ...
          <TabsContent value="individual">
            <Card>
              <CardHeader className="text-center">
                ...
                <CardDescription>Perfect for personal event planning</CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleIndividualSignup} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setIndividualData(prev => ({ ...prev, password: e.target.value }))}
                      required
                    />
                  </div>
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setIndividualData(prev => ({ ...prev, confirmPassword: e.target.value }))}
                      required
                    />
                  </div>
          ...
          <TabsContent value="business">
            <Card>
              <CardHeader className="text-center">
                <Building2 className="w-12 h-12 mx-auto text-purple-600 mb-2" />
                <CardTitle>Business Account</CardTitle>
                <CardDescription>Team collaboration with role-based access</CardDescription>
              </CardHeader>
              <CardContent>
                <form onSubmit={handleBusinessSignup} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => setBusinessData(prev => ({ ...prev, confirmPassword: e.target.value }))}
                      required
                    />
                  </div>
