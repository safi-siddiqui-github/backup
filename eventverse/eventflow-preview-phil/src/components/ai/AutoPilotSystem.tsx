...
import { Bot, Settings, Zap, CheckCircle, Clock, Users, Mail, DollarSign, Calendar } from "lucide-react";
  ...
  const generateAutomationTasks = () => {
    ...
    if (isAutoPilotEnabled) {
      ...
      newTasks.push({
        ...
        description: 'AI-optimized seating arrangement based on guest preferences',
        status: 'running',
        progress: 65,
        estimatedTime: '2 min',
        category: 'setup',
    ...
    const runningProgress = runningTasks.reduce((sum, t) => sum + t.progress, 0) / 100;
    
    const progress = totalTasks > 0 ? ((completedTasks + runningProgress) / totalTasks) * 100 : 0;
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2">
            <Label htmlFor="autopilot-toggle" className="text-sm">Enable AutoPilot</Label>
            <Switch
              id="autopilot-toggle"
      ...
      <CardContent className="space-y-6">
        {isAutoPilotEnabled ? (
          <>
            ...
            <div className="space-y-4">
              ...
              {tasks.map(task => {
                ...
                return (
                  <Card key={task.id} className={`p-4 ${getPriorityColor(task.priority)}`}>
          ...
          <div className="text-center py-8">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">AutoPilot Standby</h3>
            <p className="text-gray-600 mb-4">
              Enable AutoPilot to automatically optimize and manage your event with AI-powered automation.
            </p>
            <Button onClick={toggleAutoPilot} className="bg-indigo-600 hover:bg-indigo-700">
