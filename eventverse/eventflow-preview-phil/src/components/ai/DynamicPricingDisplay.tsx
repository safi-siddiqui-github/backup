...
import { TrendingDown, TrendingUp, Zap, Info, DollarSign } from "lucide-react";
...
const DynamicPricingDisplay = ({ selectedModules, eventType, expectedAttendees }: Props) => {
      ...
      <Card className="bg-green-50 border-green-200">
        <CardContent className="p-4">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-green-800">100% Free Setup!</span>
          </div>
          <p className="text-sm text-green-700 mt-1">
            Your selected modules are completely free. Upgrade anytime for advanced features.
          </p>
        </CardContent>
      </Card>
    );
      ...
      <CardContent className="p-4 space-y-3">
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-sm">
            ...
            <span className={cn(
              pricing.discount > 0 ? "line-through text-gray-500" : "font-semibold"
            )}>
