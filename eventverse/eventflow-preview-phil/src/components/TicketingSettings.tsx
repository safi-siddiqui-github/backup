...
import { Settings, CreditCard, Mail, FileText, Users, Shield, Globe } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-purple-100">Configure your event ticketing preferences</p>
        </div>
        ...
        <TabsContent value="general" className="mt-6">
          <Card className="bg-white/95 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription>Configure basic ticketing functionality</CardDescription>
            </CardHeader>
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(value) => handleSettingChange('ticketingEnabled', value)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(value) => handleSettingChange('salesOpen', value)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(value) => handleSettingChange('refundsEnabled', value)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(value) => handleSettingChange('transfersEnabled', value)}
                    />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleSettingChange('maxTicketsPerOrder', parseInt(e.target.value))}
                      min="1"
                      max="50"
                    />
                  </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      onChange={(e) => handleSettingChange('processingFeeRate', parseFloat(e.target.value))}
                      step="0.1"
                      min="0"
                      max="10"
                    />
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(value) => handleSettingChange('acceptCreditCards', value)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(value) => handleSettingChange('acceptPaypal', value)}
                    />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Switch
                      ...
                      onCheckedChange={(value) => handleSettingChange('acceptBankTransfer', value)}
                    />
                  </div>
                </div>
              </div>
        ...
        <TabsContent value="access" className="mt-6">
          <Card className="bg-white/95 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription>Configure customer requirements and permissions</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Customers must provide phone number during checkout</p>
                  </div>
                  <Switch
                    id="requirePhoneNumber"
                    checked={settings.requirePhoneNumber}
                    onCheckedChange={(value) => handleSettingChange('requirePhoneNumber', value)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">Customers must provide billing address</p>
                  </div>
                  <Switch
                    id="requireAddress"
                    checked={settings.requireAddress}
                    onCheckedChange={(value) => handleSettingChange('requireAddress', value)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(value) => handleSettingChange('allowGuestCheckout', value)}
                  />
                </div>
              </div>
            </CardContent>
        ...
        <TabsContent value="policies" className="mt-6">
          <Card className="bg-white/95 backdrop-blur-sm">
            <CardHeader>
              ...
              <CardDescription>Set up legal terms and conditions</CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div>
