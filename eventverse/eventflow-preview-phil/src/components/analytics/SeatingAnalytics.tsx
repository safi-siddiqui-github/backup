...
import { Layout, Users, MapPin, CheckCircle, AlertCircle, Clock } from "lucide-react";
...
const SeatingAnalytics = ({ eventId }: SeatingAnalyticsProps) => {
  ...
  const guestPreferences = [
    { preference: "Near Dance Floor", count: 45, satisfied: 38, color: "#3B82F6" },
  ...
  const seatingZones = [
    { zone: "VIP Section", tables: 3, capacity: 24, assigned: 24, status: "Full" },
    { zone: "Family Area", tables: 8, capacity: 80, assigned: 67, status: "Available" },
    { zone: "Friends Zone", tables: 10, capacity: 100, assigned: 78, status: "Available" },
    { zone: "General Seating", tables: 4, capacity: 44, assigned: 20, status: "Available" }
  ];
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold">{seatingOverview.totalTables}</div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold">{seatingOverview.totalCapacity}</div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold">{seatingOverview.assignedSeats}</div>
                <div className="text-xs text-gray-600">Assigned Seats</div>
                <Badge variant="outline" className="mt-1">{seatingOverview.utilizationRate}%</Badge>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold">{seatingOverview.unassignedSeats}</div>
            ...
            <ChartContainer config={chartConfig}>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart data={tableUtilization.slice(0, 10)}>
                  ...
                  <Bar dataKey="capacity" fill="var(--color-unassigned)" />
                </BarChart>
              </ResponsiveContainer>
            </ChartContainer>
          </CardContent>
            ...
            <div className="space-y-4">
              {guestPreferences.map((pref, index) => (
                <div key={index} className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    <div className="w-4 h-4 rounded-full" style={{ backgroundColor: pref.color }} />
              ...
              <div key={index} className="p-4 border rounded-lg">
                ...
                <div className="space-y-2 text-sm text-gray-600">
                  ...
                  <div className="flex justify-between font-medium">
                    ...
                    <span>{Math.round((zone.assigned / zone.capacity) * 100)}%</span>
                  </div>
                </div>
              </div>
            ))}
