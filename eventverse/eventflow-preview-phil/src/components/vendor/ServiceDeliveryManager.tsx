  ...
  const serviceTemplates: ServiceTemplate[] = [
    {
      ...
      stages: [
        ...
        },
        {
          ...
          duration: 21,
          required: true,
          documents: ["Service Contract", "Event Timeline", "Vendor Coordination"],
          milestones: ["Contract Signed", "Timeline Approved", "Vendors Coordinated"]
        },
        {
          id: "4",
          ...
          duration: 14,
          required: true,
          documents: ["Final Guest Count", "Setup Schedule", "Emergency Contacts"],
          milestones: ["Guest Count Confirmed", "Setup Planned", "Team Briefed"]
        },
        {
          id: "5",
          ...
          milestones: ["Event Completed", "Cleanup Finished", "Feedback Collected"]
        }
      ]
    },
    {
      ...
      stages: [
        {
          ...
          duration: 3,
          required: true,
          documents: ["Event Brief", "Dietary Requirements", "Budget Parameters"],
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">Define your service delivery process and timelines</p>
        </div>
                    ...
                    {template.stages.map((stage, index) => (
                      <div key={stage.id} className="flex items-center gap-3 p-3 border rounded-lg">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-600">{stage.duration} days</p>
                        </div>
        ...
        <TabsContent value="stages">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Define and customize your service delivery stages</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-6">
                {serviceTemplates[0].stages.map((stage, index) => (
                  <Card key={stage.id}>
                    <CardHeader>
                      <div className="flex items-center justify-between">
                        <CardTitle className="text-base">Stage {index + 1}: {stage.name}</CardTitle>
                        <div className="flex items-center gap-2">
                          <Badge variant={stage.required ? "default" : "secondary"}>
                    ...
                    <CardContent>
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                          <Label htmlFor={`duration-${stage.id}`}>Duration (days)</Label>
                          <Input
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-1 mt-1">
                            {stage.milestones.map((milestone, milestoneIndex) => (
                              <Badge key={milestoneIndex} variant="outline" className="text-xs">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Define your service commitments and response times</CardDescription>
              </CardHeader>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Define your quality checkpoints and standards</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                ...
                <div>
                  <Label htmlFor="satisfaction-guarantee">Satisfaction Guarantee</Label>
                  <Textarea
        ...
        <TabsContent value="packages">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Create different service tiers with varying timelines</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {["Basic", "Premium", "Luxury"].map((packageName) => (
                  <Card key={packageName}>
                    <CardHeader>
                      <CardTitle className="text-lg">{packageName} Package</CardTitle>
                    </CardHeader>
                    <CardContent>
                      <div className="space-y-3">
                        <div className="flex items-center justify-between">
                          ...
                          <Badge variant="outline">
                            {packageName === "Basic" ? "30 days" : packageName === "Premium" ? "60 days" : "90 days"}
                          </Badge>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-sm">Consultations</span>
                          <Badge variant="outline">
                            {packageName === "Basic" ? "1" : packageName === "Premium" ? "2" : "3"}
                          </Badge>
                        </div>
                        <div className="flex items-center justify-between">
                          <span className="text-sm">Revisions</span>
                          <Badge variant="outline">
                            {packageName === "Basic" ? "2" : packageName === "Premium" ? "4" : "Unlimited"}
                          </Badge>
                        </div>
