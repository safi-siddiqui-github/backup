...
const ContractDialog = ({ children, clientId }: ContractDialogProps) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    console.log("Creating contract:", { ...contract, deliverables, startDate, endDate });
    toast({
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Select value={contract.clientName} onValueChange={(value) => setContract(prev => ({ ...prev, clientName: value }))}>
                <SelectTrigger>
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => setContract(prev => ({ ...prev, projectName: e.target.value }))}
          ...
          <div>
            ...
            <Select value={contract.template} onValueChange={(value) => setContract(prev => ({ ...prev, template: value }))}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <Input
                ...
                onChange={(e) => setContract(prev => ({ ...prev, amount: e.target.value }))}
                placeholder="7500"
                required
              />
            </div>
            ...
            <div>
              ...
              <Select value={contract.paymentTerms} onValueChange={(value) => setContract(prev => ({ ...prev, paymentTerms: value }))}>
                <SelectTrigger>
                  <SelectValue />
                </SelectTrigger>
                <SelectContent>
                  <SelectItem value="50% deposit, 50% on completion">50% deposit, 50% on completion</SelectItem>
                  <SelectItem value="30% deposit, 70% on completion">30% deposit, 70% on completion</SelectItem>
