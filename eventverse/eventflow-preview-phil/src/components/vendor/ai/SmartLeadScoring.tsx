...
import { Target, Brain, TrendingUp, DollarSign, Clock, Users, Star } from "lucide-react";
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-5xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            AI-powered lead analysis and prioritization based on conversion probability
          </DialogDescription>
        </DialogHeader>
                ...
                <CardHeader className="pb-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-xs text-gray-500 mt-1">{getScoreLevel(lead.score)}</p>
                    </div>
                  </div>
                </CardHeader>
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    ...
                    <div>
                      ...
                      <p className="font-medium">{new Date(lead.eventDate).toLocaleDateString()}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600">Timeline</p>
                      <p className="font-medium">
                        {Math.ceil((new Date(lead.eventDate).getTime() - new Date().getTime()) / (1000 * 60 * 60 * 24))} days
                      </p>
                    </div>
                  </div>
                  ...
                  {selectedLead === lead.id && (
                    <div className="space-y-4 pt-4 border-t">
                      {/* Scoring Factors */}
                      <div>
                        <h4 className="font-medium mb-3">AI Scoring Factors</h4>
