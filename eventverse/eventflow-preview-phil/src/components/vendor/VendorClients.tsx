  ...
  const [clients] = useState<Client[]>([
    {
      ...
      status: "active",
      projects: [
        { id: "p1", name: "Wedding Catering", date: "2024-08-15", value: 7500, status: "upcoming" },
        { id: "p2", name: "Engagement Party", date: "2023-12-10", value: 3500, status: "completed" },
        { id: "p3", name: "Bridal Shower", date: "2023-10-20", value: 4000, status: "completed" }
      ]
    },
    {
      id: "2",
      ...
      status: "active",
      projects: [
        { id: "p4", name: "Corporate Gala", date: "2024-09-20", value: 12000, status: "upcoming" },
        { id: "p5", name: "Holiday Party", date: "2023-12-15", value: 8000, status: "completed" }
      ]
    },
    {
      id: "3",
      ...
      status: "inactive",
      projects: [
        { id: "p6", name: "Birthday Party", date: "2023-07-30", value: 3500, status: "completed" }
      ]
    },
    {
      id: "4",
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4 text-center">
                ...
                <div className="bg-blue-50 p-3 rounded">
                  <p className="text-lg font-bold text-blue-600">{client.completedProjects}</p>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-3 gap-4 text-center">
                  ...
                  <div>
                    <p className="text-lg font-bold text-blue-600">{client.activeContracts}</p>
                    <p className="text-xs text-gray-500">Active</p>
                  </div>
                  <div>
                    <p className="text-lg font-bold text-purple-600">{client.completedProjects}</p>
