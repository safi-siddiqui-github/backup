...
const RewardSystem = () => {
  ...
  const isRewardUnlockable = (reward: Reward) => {
    ...
    if (reward.requiredLevel && currentLevel >= reward.requiredLevel) return true;
        ...
        <CardContent>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {unlockedRewards.map((reward) => (
              <div 
                key={reward.id}
                className={`p-4 rounded-lg bg-gradient-to-r ${getRarityColor(reward.rarity)} text-white relative overflow-hidden`}
              >
                    ...
                    <div className="flex items-start gap-3 flex-1">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-xs text-muted-foreground">
                          ...
                          {reward.requiredXP && (
                            <span>Requires {reward.requiredXP.toLocaleString()} XP</span>
                          )}
