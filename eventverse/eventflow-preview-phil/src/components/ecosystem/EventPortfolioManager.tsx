    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">Manage and analyze your entire event ecosystem</p>
        </div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold">{portfolioData.totalEvents}</div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold">{portfolioData.activeEvents}</div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold">${portfolioData.totalRevenue.toLocaleString()}</div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold">{portfolioData.totalAttendees.toLocaleString()}</div>
        ...
        <Card>
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold">{portfolioData.avgSatisfaction}</div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-600 mb-3">
                        {series.events} events completed • Next: {series.nextEvent} on {series.nextDate}
                      </p>
                      <div className="flex items-center gap-4">
                        <div className="text-sm">
                          <span className="text-gray-500">Avg. Attendance:</span>
                          <span className="font-medium ml-1">{series.avgAttendance}%</span>
                        </div>
                        <Progress value={series.avgAttendance} className="w-32 h-2" />
                      </div>
                    </div>
              ...
              <CardContent>
                <div className="space-y-4">
                  <div className="p-4 bg-blue-50 rounded-lg">
                    <h4 className="font-medium text-blue-900">Best Performing Event Type</h4>
                    <p className="text-blue-700 text-sm mt-1">
                      Networking events show 23% higher satisfaction rates
                    </p>
                  </div>
                  <div className="p-4 bg-green-50 rounded-lg">
                    <h4 className="font-medium text-green-900">Optimal Event Timing</h4>
                    <p className="text-green-700 text-sm mt-1">
                      Thursday evenings generate 18% more registrations
                    </p>
                  </div>
                  <div className="p-4 bg-purple-50 rounded-lg">
                    <h4 className="font-medium text-purple-900">Resource Efficiency</h4>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Resource Allocation Dashboard</h3>
