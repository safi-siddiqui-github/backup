    ...
    <div className="space-y-6 p-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-2">Advanced business intelligence and performance insights</p>
        </div>
        ...
        <Card className="border-blue-200 bg-blue-50">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold text-blue-900">{kpiData.totalROI}%</div>
        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold text-green-900">{kpiData.customerAcquisition}</div>
        ...
        <Card className="border-purple-200 bg-purple-50">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold text-purple-900">{kpiData.revenueGrowth}%</div>
        ...
        <Card className="border-orange-200 bg-orange-50">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold text-orange-900">{kpiData.marketShare}%</div>
        ...
        <Card className="border-indigo-200 bg-indigo-50">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold text-indigo-900">{kpiData.brandAwareness}%</div>
        ...
        <Card className="border-pink-200 bg-pink-50">
          <CardContent className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="text-xl font-bold text-pink-900">{kpiData.customerSatisfaction}</div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Comprehensive Financial Analytics</h3>
                  ...
                  <div key={index} className="flex items-center justify-between p-4 border rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">Compliance Score: {item.score}%</p>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
          ...
          <Card>
            ...
            <CardContent>
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">AI-Powered Predictions</h3>
                <p className="text-gray-600 mb-4">
