...
const VendorTimelineTracker = ({ milestones, contracts, vendors }: VendorTimelineTrackerProps) => {
  ...
  const milestonesByDate = sortedMilestones.reduce((acc, milestone) => {
  ...
  const upcomingMilestones = sortedMilestones.filter(milestone => {
    ...
    return milestone.dueDate >= today && milestone.dueDate <= nextWeek && milestone.status !== 'completed';
  });
                    ...
                    return (
                      <div key={milestone.id} className="flex justify-between items-center">
                        ...
                        <Badge className="bg-red-100 text-red-800">
                          {Math.ceil((new Date().getTime() - milestone.dueDate.getTime()) / (1000 * 60 * 60 * 24))} days late
                        </Badge>
                      </div>
                    );
                  })}
                    ...
                    <div className="flex-1">
                      <div className="flex items-start justify-between mb-2">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">{vendor?.name} • {vendor?.category}</p>
                        ...
                        <div className="flex flex-col items-end gap-2">
                          ...
                          <Badge className={getStatusColor(isOverdue(milestone) ? 'overdue' : milestone.status)}>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-center py-8">
              ...
              <p className="text-sm text-gray-400">Use list view to see all milestones</p>
            </div>
          </CardContent>
        </Card>
      )}
