...
const AIThemeGenerator = ({ formData, onUpdate }: Props) => {
  ...
  const processThemeDescription = (desc: string): GeneratedTheme => {
    ...
    // Winter/Snow themes
    if (lower.includes('winter') || lower.includes('snow') || lower.includes('ice')) {
      return {
    ...
    // Beach/Ocean themes
    if (lower.includes('beach') || lower.includes('ocean') || lower.includes('tropical')) {
      return {
        ...
        mood: "relaxed",
        description: "Ocean blues and sunset oranges with gentle wave animations"
      };
    }
    
    // Elegant/Wedding themes
    if (lower.includes('elegant') || lower.includes('wedding') || lower.includes('gold')) {
      return {
    ...
    // Fun/Kids themes
    if (lower.includes('fun') || lower.includes('kids') || lower.includes('rainbow') || lower.includes('colorful')) {
      return {
    ...
    if (lower.includes('corporate') || lower.includes('professional') || lower.includes('business')) {
      return {
        ...
        mood: "professional",
        description: "Clean blues and grays with smooth, professional animations"
      };
    }
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h4 className="text-lg font-semibold text-gray-900">AI Theme Generator</h4>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="space-y-3">
          <div>
            <Label htmlFor="theme-description" className="text-sm font-medium text-gray-700">
          ...
          <div className="flex flex-wrap gap-1">
            ...
            {examplePrompts.map((prompt, index) => (
              <Button
                ...
                variant="ghost"
                size="sm"
                className="text-xs h-6 px-2 text-gray-600 hover:text-purple-600"
        ...
        {generatedTheme && (
          <Card className="border-purple-200 bg-gradient-to-br from-purple-50 to-blue-50">
            <CardContent className="p-4">
              ...
              <p className="text-sm text-gray-600 mb-3">{generatedTheme.description}</p>
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-1 mt-1">
                    <Badge variant="outline" className="text-xs">{generatedTheme.mood}</Badge>
