...
const EventFAQsField = ({ data = [], onUpdate }: Props) => {
  ...
  const commonQuestions = [
    { category: "general", question: "What should I bring to the event?", answer: "" },
    { category: "general", question: "What is the dress code?", answer: "" },
    { category: "general", question: "Is the event rain or shine?", answer: "" },
    { category: "tickets", question: "Can I get a refund for my ticket?", answer: "" },
    { category: "tickets", question: "Can I transfer my ticket to someone else?", answer: "" },
    { category: "logistics", question: "What time does the event start and end?", answer: "" },
    { category: "logistics", question: "Where should I park?", answer: "" },
    { category: "food", question: "Will food be provided?", answer: "" },
    { category: "food", question: "Can you accommodate dietary restrictions?", answer: "" },
    { category: "accessibility", question: "Is the venue wheelchair accessible?", answer: "" }
  ];
    ...
    <div className="space-y-4">
          ...
          <CardContent className="pt-6">
            <div className="text-center py-8">
              ...
              <p className="text-sm text-muted-foreground mb-4">
                Add frequently asked questions to help attendees get quick answers
              </p>
              
              {/* Quick Add Common Questions */}
              <div className="space-y-2 max-w-md mx-auto">
                <h4 className="text-sm font-medium text-left">Quick Add Common Questions:</h4>
      ...
      {faqs.length > 0 && faqs.some(faq => faq.question && faq.answer) && (
        <Card className="bg-primary/5 border-primary/20">
          <CardHeader className="pb-3">
            <CardTitle className="text-sm text-primary">FAQ Preview</CardTitle>
          </CardHeader>
          <CardContent className="space-y-3">
            {faqs
              ...
              .map((faq, index) => (
                <div key={faq.id} className="space-y-1">
                  <h4 className="font-medium text-sm">Q: {faq.question}</h4>
                  <p className="text-sm text-muted-foreground pl-3">A: {faq.answer}</p>
