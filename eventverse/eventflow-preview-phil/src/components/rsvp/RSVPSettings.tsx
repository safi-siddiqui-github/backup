...
const RSVPSettings = ({ settings, onUpdate }: RSVPSettingsProps) => {
  const [registryLinks, setRegistryLinks] = useState<RegistryLink[]>(settings.registryLinks || []);
  const [newRegistry, setNewRegistry] = useState({ name: "", url: "", platform: "", description: "" });

  const handleSettingChange = (key: keyof RSVPSettingsType, value: any) => {
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <Popover>
                    <PopoverTrigger asChild>
                      ...
                      >
                        ...
                        {settings.deadline ? format(settings.deadline, "PPP") : "Select deadline"}
                      </Button>
                    </PopoverTrigger>
                    <PopoverContent className="w-auto p-0" align="start">
                      <Calendar
                        ...
                        onSelect={(date) => handleSettingChange('deadline', date)}
                        initialFocus
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => handleSettingChange('responseOptions', value)}
                  >
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                      ...
                      <SelectItem value="yes-no-maybe">Yes / No / Maybe</SelectItem>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('capacityLimit', 
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(e) => handleSettingChange('maxPlusOnes', parseInt(e.target.value) || 0)}
                    min="0"
                    max="10"
                  />
                </div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSettingChange('allowPlusOnes', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSettingChange('collectDietaryInfo', checked)}
                  />
                </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    ...
                    onCheckedChange={(checked) => handleSettingChange('enableCustomFields', checked)}
                  />
                </div>
              </div>
            </CardContent>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-3">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Allow anyone with the link to RSVP</p>
                  </div>
                  <Switch
                    id="public"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Manually approve each RSVP</p>
                  </div>
                  <Switch
                    id="approval"
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Send reminder emails automatically</p>
                  </div>
                  <Switch
                    id="reminders"
              ...
              {settings.publicRegistration && (
                <div className="p-4 bg-blue-50 rounded-lg">
                  <h4 className="font-medium text-blue-800 mb-2">Shareable Event Page</h4>
                  <p className="text-sm text-blue-700 mb-3">
                    Your event will be accessible via a public link that you can share on social media, 
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setNewRegistry({...newRegistry, platform: value})}
                  >
                    <SelectTrigger>
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="bed-bath-beyond">Bed Bath & Beyond</SelectItem>
                      <SelectItem value="williams-sonoma">Williams Sonoma</SelectItem>
                      <SelectItem value="honeymoon-fund">Honeymoon Fund</SelectItem>
                ...
                <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    {registryLinks.map((registry) => (
                      <div key={registry.id} className="flex items-center justify-between p-3 border rounded-lg">
                        <div>
                          <div className="font-medium">{registry.name}</div>
                          <div className="text-sm text-gray-500">{registry.platform}</div>
                          {registry.description && (
                            <div className="text-xs text-gray-400">{registry.description}</div>
                          )}
                        </div>
                        <Button
                          variant="ghost"
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select defaultValue="standard">
                    ...
                    <SelectContent>
                      <SelectItem value="standard">Standard (2 weeks, 1 week, 3 days)</SelectItem>
                      <SelectItem value="frequent">Frequent (2 weeks, 1 week, 3 days, 1 day)</SelectItem>
                      <SelectItem value="minimal">Minimal (1 week, 3 days)</SelectItem>
                      <SelectItem value="custom">Custom</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
