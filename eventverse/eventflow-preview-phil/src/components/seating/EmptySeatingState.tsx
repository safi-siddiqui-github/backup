      ...
      <Card className="max-w-2xl mx-auto">
        <CardContent className="p-12 text-center">
          ...
          <p className="text-muted-foreground mb-8 max-w-md mx-auto">
            Get started by creating your first seating arrangement. You can design table layouts,
            manage guest assignments, and organize multiple venues and sections.
          </p>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <ul className="text-sm text-muted-foreground space-y-1">
                  ...
                  <li>• Create sections within locations (e.g., VIP Area, Main Floor)</li>
                  <li>• Design multiple arrangements for different times or events</li>
