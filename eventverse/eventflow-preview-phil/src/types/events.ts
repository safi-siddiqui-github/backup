// Event-related types
export type EventType = 'Wedding' | 'Cultural' | 'Business' | 'Personal' | 'Wellness' | 'Holiday' | 'Educational' | 'Corporate' | 'Charity' | 'Festival' | 'Conference';

export type EventStatus = 'draft' | 'published' | 'active' | 'completed' | 'cancelled';

export type RSVPStatus = 'confirmed' | 'pending' | 'declined' | 'attending' | 'maybe';
